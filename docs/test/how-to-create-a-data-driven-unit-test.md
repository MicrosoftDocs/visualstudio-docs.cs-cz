---
title: Vytvořit Data-Driven testování částí
description: Naučte se, jak pomocí rozhraní Microsoft Unit Test Framework pro spravovaný kód nastavit metodu testování částí pro načtení hodnot ze zdroje dat.
