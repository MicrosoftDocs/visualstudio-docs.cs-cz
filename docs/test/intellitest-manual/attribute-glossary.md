...
description: Tento článek poskytuje seznam atributů IntelliTest uspořádaných podle oboru názvů a podrobností pro atributy.
...
Je také velmi doporučeno, aby tyto třídy byly **částečně** tak, aby IntelliTest mohli generovat nové testy, které jsou součástí třídy, ale v samostatném souboru. Tento přístup řeší mnohé problémy z důvodu [viditelnosti](input-generation.md#visibility) a je typickou technikou v jazyce C#.
