...
3. V **Zadejte název kontroleru pro hledání výsledků zátěžového testu**, vyberte kontroler. Pro přístup k výsledkům uloženým místně vyberte **\<local >** .
