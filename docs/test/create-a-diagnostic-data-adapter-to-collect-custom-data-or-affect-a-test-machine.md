...
description: Naučte se psát kód, který provede úkoly v konkrétních místech testovacího běhu pomocí rozhraní API poskytovaných v rámci Visual Studio Enterprise.
