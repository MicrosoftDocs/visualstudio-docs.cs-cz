...
Tato nastavení způsobí, že **analyzátor zátěžového testu** upraví uživatelské zatížení mezi 1 a 100 během testovacího běhu takovým způsobem, že **čítač** pro `% Processor Time` webserver01 najede myší `70%` a `90%.`
