---
title: Vytvoření Plug-In testu výkonnosti webu
description: Přečtěte si, jak moduly plug-in testu výkonu webu umožňují opakované použití kódu mimo hlavní deklarativní příkazy v testu výkonnosti webu.
