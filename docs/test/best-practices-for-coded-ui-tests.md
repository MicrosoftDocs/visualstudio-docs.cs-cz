...
description: Přečtěte si o doporučeních pro vývoj programových testů uživatelského rozhraní. Tyto pokyny slouží k vytvoření flexibilního programového testu uživatelského rozhraní.
