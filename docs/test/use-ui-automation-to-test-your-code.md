...
- Přidejte metodu čištění testu identifikovanou atributem `[TestCleanup]`, který spouští kód na konci každé testovací metody. Například metoda zavření aplikace by mohla být volána z metody TestCleanup.
