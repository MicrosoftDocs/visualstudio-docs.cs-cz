...
description: Naučte se používat další nastavení pro zátěžový test, včetně doby trvání testu, úrovně podrobností kolekce výsledků a shromažďovaných sad čítačů.
