...
ms.locfileid: "91860851"
---
# <a name="require-azurecli"></a>require-azurecli

Tento `require-azurecli` nástroj slouží k instalaci [Azure CLI](/cli/azure/?preserve-view=true&view=azure-cli-latest) přes Azure CLI MSI.
