...
description: Příklad použití všech nástrojů devinit
ms.date: 02/08/2021
ms.topic: reference
author: andysterland
ms.author: andster
...
ms.locfileid: "104672472"
---
# <a name="all-tools"></a>Všechny nástroje
...
V tomto příkladu je `devinit.json` , který nainstaluje všechny dostupné nástroje devinit.
