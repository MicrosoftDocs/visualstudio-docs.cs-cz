---
title: 'Návod: Používání IntelliSense pro XSLT'
ms.date: 11/04/2016
ms.topic: conceptual
...
2. Vložte kurzor po `<xsl:stylesheet version="1.0">` a stiskněte klávesu **ENTER**. Pak začněte psát následující prvek `xsl:namespace-alias`:
