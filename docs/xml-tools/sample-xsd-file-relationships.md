...
description: Zobrazit ukázkový soubor XSD pro schéma nákupních objednávek s poznámkami a dokumentací, který se používá v různých příkladech v dokumentaci k Návrháři schématu XSD.
