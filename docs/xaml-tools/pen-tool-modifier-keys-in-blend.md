...
description: Přečtěte si o modifikačních klíčích nástroje pero v Blend pro Visual Studio, které přistupují k příkazům pro úpravu cesty při vytváření pomocí nástroje pero.
...
ms.locfileid: "99846267"
---
# <a name="pen-tool-modifier-keys-in-blend-for-visual-studio"></a>Modifikační klávesy nástroje pero v Blend pro Visual Studio

V následující tabulce jsou uvedeny zkratky, které můžete použít k úpravě cesty při jejím vytváření pomocí nástroje **pero Tool Tool** ![ ](../designers/media/d514358f-185a-412f-a55d-36633b25dc8a.png) . Nástroj **pero** můžete také použít k přidání nebo odebrání bodů v existující cestě nebo ke spojení dvou existujících cest.
...
|Přesunout koncový bod tečny kolem nového bodu s přírůstky na 15 stupňů|Kliknutím vytvoříte nový bod a pak podržíte klávesu **SHIFT** + **+ ALT** a přetáhnete před uvolněním tlačítka myši.|![Přesunout koncový bod tečny kolem nového bodu s přírůstky na 15 stupňů](../designers/media/317e5475-b70c-489f-9477-110a98639ade.png)<br /><br /> Upravit ukazatel pera|
