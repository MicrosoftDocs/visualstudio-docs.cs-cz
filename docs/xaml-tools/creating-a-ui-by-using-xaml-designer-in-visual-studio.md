...
Chcete-li zobrazit okno Objekty a časová osa v Blend pro Visual Studio, v řádku nabídek vyberte **zobrazení** > **Osnova dokumentu**.
...
Zobrazí nebo skryje prvky návrhové plochy. Zobrazuje se jako symbol oka, pokud je zobrazený. Můžete také stisknout **ctrl**+**H** pro skrytí prvku a **Shift**+**CTRL**+**H** , aby se zobrazila.

**Zamknout/odemknout**

Zamkne nebo odemkne prvky návrhové plochy. Uzamčené prvky nelze upravovat. Zobrazuje se jako symbol visacího zámku nezobrazuje při uzamčení. Můžete také stisknout **ctrl**+**L** pro zamčení prvku a **Shift**+**CTRL**+**L** k jeho odemčení.
