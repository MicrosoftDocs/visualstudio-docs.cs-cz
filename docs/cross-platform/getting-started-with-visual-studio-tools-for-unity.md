...
description: Začínáme s Visual Studio Tools for Unity. Nainstalujte si Visual Studio, nakonfigurujte Unity pro použití se sadou Visual Studio a získejte informace o podpoře pro starší verze.
ms.custom: ''
ms.date: 05/11/2020
