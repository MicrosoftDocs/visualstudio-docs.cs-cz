...
|[Instalace vývoje mobilních aplikací pro různé platformy pomocíC++](/cpp/cross-platform/install-visual-cpp-for-cross-platform-mobile-development)|
...
|[Nainstalujte, co potřebujete, a pak vytvořte C++ nativní aplikaci aktivity pro Android.](/cpp/cross-platform/create-an-android-native-activity-app)|
...
|[Příklady vývoje mobilních aplikací pro různé platformy proC++](/cpp/cross-platform/cross-platform-mobile-development-examples)|
