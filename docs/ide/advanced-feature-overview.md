...
- Použijte standardní webové technologie &mdash;HTML, šablon stylů CSS a JavaScriptu &mdash;to sestavování mobilních aplikací pro iOS, Android a Windows pomocí [Apache Cordova](/visualstudio/cross-platform/tools-for-cordova/).
