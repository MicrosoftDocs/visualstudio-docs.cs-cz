...
Nativní C++ kód nelze upravovat pomocí Návrhář tříd nebo okna **podrobností třídy** . pro úpravu nativního C++ kódu je nutné použít Editor kódu.
