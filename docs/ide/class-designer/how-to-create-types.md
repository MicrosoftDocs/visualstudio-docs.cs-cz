...
Chcete-li navrhnout nové C# typy pro a Visual Basic projekty, vytvořte je v diagramu tříd. Chcete-li zobrazit existující typy, přečtěte si téma [Postup: zobrazení existujících typů](how-to-view-existing-types.md).
