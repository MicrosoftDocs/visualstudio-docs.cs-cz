...
description: Přečtěte si o přepínači příkazového řádku devenv sestavení a o tom, jak ho použít k sestavení řešení nebo projektu se zadaným konfiguračním souborem řešení.
