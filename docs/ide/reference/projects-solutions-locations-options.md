...
---
# <a name="options-dialog-box-projects-and-solutions--locations"></a>Dialogové okno Možnosti: projekty a řešení \> umístění

Tato stránka slouží k nastavení výchozích umístění pro projekty, šablony projektů a šablony položek. Chcete-li získat přístup k těmto možnostem, vyberte **nástroje** > **Možnosti**, rozbalte **projekty a řešení**a potom vyberte **umístění**.
