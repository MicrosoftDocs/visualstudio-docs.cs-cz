...
Pomocí stránky **linting** dialogového okna **Možnosti** můžete nastavit možnosti analýzy kódu v editoru kódu. Chcete-li získat přístup k této stránce, v řádku **Tools**nabídek zvolte  >  **možnost**nástroje a potom rozbalte **textový editor**  >  **JavaScript/TypeScript**  >  **linting**.
