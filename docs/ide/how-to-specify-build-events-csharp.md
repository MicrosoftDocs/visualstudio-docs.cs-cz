...
4. Publikujte projekt kliknutím na **Publikovat nyní**.
   ...
   Soubor manifestu je sestaven a uložen do *složce c:\temp\ CSWinApp_1_0_0_0 \cswinapp.exe.manifest*. Chcete-li zobrazit manifest, klikněte pravým tlačítkem myši na soubor, klikněte na možnost **otevřít**v aplikaci, vyberte **možnost vybrat program v seznamu**a pak klikněte na tlačítko **Poznámkový blok**.
