...
3. Přetáhněte <xref:System.Windows.Forms.TableLayoutPanel> ovládací prvek z kategorie **kontejnery** v sadě nástrojů a nastavte pro něj následující vlastnosti.
...
5. Vyberte ovládací prvek popisku a zkopírujte jej na další buňku v kontejneru TableLayoutPanel. (Klikněte na **CTRL** + Klíče **C** nebo na panelu nabídek vyberte možnost **Upravit**  >  **kopii**.) Pak jej vložte. (Klikněte na **CTRL** + **V** klíčích nebo na panelu nabídek vyberte možnost **Upravit**  >  **vložení**.) Kopie prvního popisku se zobrazí v druhé buňce kontejneru TableLayoutPanel. Vložte ho znovu a pod třetí buňku se zobrazí další popisek. Nechejte vkládat ovládací prvky popisku, dokud nebudou všechny buňky vyplněny.
