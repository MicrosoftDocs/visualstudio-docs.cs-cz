...
Okno ***vlastnosti*** *zobrazující* ***TableLayoutPanel*** *ovládací prvek* TableLayoutPanel
...
Okno ***vlastností*** *s* ***Fill*** *vybraným* výplní
...
***TableLayoutPanel*** *Úlohy* TableLayoutPanel
...
***TableLayoutPanel*** *Styly sloupců a řádků* TableLayoutPanel
