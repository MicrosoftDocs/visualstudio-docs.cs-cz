...
|Příkazy|Klávesové zkratky|
|--------------|-|
|Edit.Copy|**CTRL + C**<br /><br /> nebo<br /><br /> **CTRL + in**|
|Edit.Cut|**CTRL + X**<br /><br /> nebo<br /><br /> **Shift + Delete**|
|Edit.CycleClipboardRing|**Ctrl + Shift + V**<br /><br /> nebo<br /><br /> **Ctrl + Shift + in**|
|Edit.Delete|**Delete**|
...
|Edit.Paste|**CTRL + V**<br /><br /> nebo<br /><br /> **SHIFT + in**|
...
|Příkazy|Klávesové zkratky|
|--------------| - |
|SolutionExplorer.OpenFilesFilter|**CTRL + [** , **O** (písmeno "jednoznakový)<br /><br /> nebo<br /><br /> **CTRL + [** , **Ctrl + O** (písmeno "jednoznakový)|
...
|Team.Git.GoToGitCommits|**CTRL + 0** (nula), **Ctrl + O** (písmeno "jednoznakový)<br /><br /> nebo<br /><br /> **CTRL + 0, O**|
...
|View.PopBrowseContext|**CTRL + SHIFT + 8** (C++ pouze)|
...
|Window.NextTab|**Ctrl + Alt + PAGE DOWN**<br /><br /> nebo<br /><br /> **CTRL + PAGE DOWN**|
...
|Window.PreviousTab|**Ctrl + Alt + Page Up**<br /><br /> nebo<br /><br /> **CTRL + PAGE UP**|
...
| Příkazy | Klávesové zkratky |
| - | - |
| Edit.BreakLine | **Zadejte**<br /><br /> nebo<br /><br /> **Shift + Enter** |
| Edit.CharLeft | **Šipka doleva** |
| Edit.CharLeftExtend | **Shift + šipka doleva** |
...
| Edit.CompleteWord | **CTRL + MEZERNÍK**<br /><br /> nebo<br /><br /> **ALT + Šipka vpravo** |
...
|Format.SpaceAcross|**ALT + Šipka vpravo**<br /><br /> nebo<br /><br /> **ALT + Šipka doleva**|
...
|Image.NextColor|**CTRL +]**<br /><br /> nebo<br /><br /> **Ctrl + šipka vpravo**|
...
|Příkazy|Klávesové zkratky|
|--------------| - |
|Edit.CompleteWord|**CTRL + K, W**<br /><br /> nebo<br /><br /> **CTRL + K, Ctrl + W**<br /><br /> nebo<br /><br /> **CTRL + MEZERNÍK**<br /><br /> nebo<br /><br /> **ALT + Šipka vpravo**|
|Edit.DecreaseFilterLevel|**ALT +**|
|Edit.IncreaseFilterLevel|**ALT +.**|
...
|Edit.QuickInfo|**CTRL + K, můžu**<br /><br /> nebo<br /><br /> **CTRL + K, Ctrl + I**|
...
|WorkflowDesigner.ShowHideImportsDesigner|**CTRL + E, Ctrl + I**<br /><br /> nebo<br /><br /> **CTRL + E, můžu**|
|WorkflowDesigner.ShowHideOverviewMap|**CTRL + E, Ctrl + O** (písmeno "jednoznakový)<br /><br /> nebo<br /><br /> **CTRL + E, O**|
