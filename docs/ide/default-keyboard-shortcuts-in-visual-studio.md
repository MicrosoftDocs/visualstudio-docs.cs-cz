...
|Edit.MoveControlLeft|**Ctrl + šipka vlevo**|
|Edit.MoveControlLeftGrid|**Šipka vlevo**|
...
|Edit.SizeControlLeft|**CTRL + SHIFT + šipka vlevo**|
...
|Příkaz|Klávesová zkratka|
|-------------| - |
|OtherContextMenus.MicrosoftDataEntityDesignContext.AddNewDiagram|**Zadat**|
...
|Team.Git.GoToGitCommits|**CTRL + 0** (nula), **CTRL + O** (Letter ' O ')<br /><br /> or<br /><br /> **CTRL + 0, O**|
...
|Zobrazit. PopBrowseContext|**CTRL + SHIFT + 8** (C++ pouze)|
...
|Příkazy|Klávesové zkratky|
|--------------| - |
|Window.ActivateDocumentWindow|**Kláves**|
...
|Příkazy|Klávesové zkratky|
|--------------| - |
|OtherContextMenus.ColumnContext.InsertColumn|**Zadat**|
...
|Příkazy|Klávesové zkratky|
|--------------| - |
|ArchitectureContextMenus.DirectedGraphContextMenu.Advanced.Add.AddNode|**Zadat**|
...
|TeamFoundationContextMenus.Commands.TeamExplorerNavigateBackward|**Alt + šipka vlevo**|
...
| Příkazy | Klávesové zkratky |
| - | - |
| Edit.BreakLine | **Napište**<br /><br /> or<br /><br /> **SHIFT + ENTER** |
| Edit.CharLeft | **Šipka vlevo** |
| Edit.CharLeftExtend | **Shift + šipka doleva** |
...
| Upravit. GotoAll | **CTRL + T**<br /><br /> or<br /><br /> **CTRL +,** |
| Edit.GotoBrace | **CTRL +]** |
| Edit.GotoBraceExtend | **CTRL + SHIFT +]** |
| Upravit. GotoRecent | **CTRL + T, R** |
| Upravit. GotoNextIssueinFile | **Alt + Page Down** |
| Upravit. GotoPreviousIssueinFile | **Alt + Page Up** |
...
| Edit.WordPrevious | **Ctrl + šipka vlevo** |
| Edit.WordPreviousExtend | **CTRL + SHIFT + šipka vlevo** |
...
|Edit.MoveControlLeft|**Šipka vlevo**|
|Edit.MoveControlRight|**Šipka doprava**|
|Edit.MoveControlUp|**Šipka nahoru**|
|Edit.ScrollColumnLeft|**Ctrl + šipka vlevo**|
...
|Format.AlignLefts|**CTRL + SHIFT + šipka vlevo**|
...
|Format.SpaceAcross|**Alt + šipka doprava**<br /><br /> or<br /><br /> **Alt + šipka vlevo**|
...
|Image.PreviousColor|**CTRL + [**<br /><br /> or<br /><br /> **Ctrl + šipka vlevo**|
|Image.PreviousRightColor|**CTRL + SHIFT + [**<br /><br /> or<br /><br /> **CTRL + SHIFT + šipka vlevo**|
...
|GraphView.RighttoLeft|**Alt + šipka vlevo**|
