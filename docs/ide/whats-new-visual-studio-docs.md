---
title: 'Dokumentace sady Visual Studio: co je nového v březnu 2021'
titleSuffix: ''
description: Novinky v dokumentaci sady Visual Studio pro březen 2021.
ms.date: 04/02/2021
helpviewer_keywords:
...
Vítá vás novinky v dokumentaci sady Visual Studio pro březen 2021. V tomto článku jsou uvedené některé hlavní změny v dokumentaci v průběhu tohoto období. Informace o tom, co bylo v předchozích měsících nového, najdete v článku [co je nového v historii](whats-new-visual-studio-docs-history.md) .

## <a name="code-quality"></a>Kvalita kódu

**Aktualizované články**

- [Postupy: ruční spuštění analýzy starších kódů pro spravovaný kód](../code-quality/how-to-run-legacy-code-analysis-manually-for-managed-code.md) – potvrzení sloučení z pracovní větve
...
- [Element VisibilityItem](../extensibility/visibilityitem-element.md) – potvrzení sloučení z pracovní větve
...
- [Kurz: Začínáme s C# a ASP.NET Core v aplikaci Visual Studio](../get-started/csharp/tutorial-aspnet-core.md)
  - Potvrdit sloučení z pracovní větve
  - Aktualizovat tutorial-aspnet-core.md
...
- [Řešení potíží a vytváření protokolů pro problémy nástroje MSBuild](./msbuild-logs.md) – potvrzení sloučení z pracovní větve
...
- [grossag](https://github.com/grossag) -Adam brutto (1)
