...
* ![Roamingovaná ikona roamingu ](media/vs2017ide-roamedicon.png) ****: rozšíření, které je součástí tohoto seznamu roamingu, ale není nainstalované na vašem počítači.
...
**Novinka v 15,8**: teď můžete své vazby klíčů udržovat v souladu s nástroji pomocí dvou nových profilů klávesnice: Visual Studio Code a reostřejšíer (Visual Studio). Tato schémata najdete v části možnosti **nástrojů**  >    >  **Obecné**  >  **klávesnice** a horní rozevírací nabídka.
...
Také jsme opravili více než 250 chyb a nahlásili problémy v kompilátoru a nástrojích, mnoho odeslaných zákazníky prostřednictvím [komunity vývojářů pro C++](https://aka.ms/feedback/report?space=62 "Komunita vývojářů pro C++").
