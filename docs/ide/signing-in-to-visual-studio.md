...
- **Prodloužení zkušebního období sady Visual Studio** – můžete použít Visual Studio Professional nebo Visual Studio Enterprise po dobu dalších 90 dní, a nikoli omezit na zkušební dobu 30 dní.

- **Pokud používáte účet, který je přidružený k předplatnému sady Visual Studio nebo organizaci Azure DevOps, odemkněte Visual Studio**. Podívejte [se, jak odemknout Visual Studio](../ide/how-to-unlock-visual-studio.md).
