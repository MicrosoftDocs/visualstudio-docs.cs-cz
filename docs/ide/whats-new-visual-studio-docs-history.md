...
titleSuffix: ''
description: Historie novinky v dokumentaci sady Visual Studio
ms.date: 09/01/2020
helpviewer_keywords:
...
ms.locfileid: "89410503"
---
# <a name="history-of-whats-new-in-visual-studio-docs"></a>Historie novinky v dokumentaci sady Visual Studio

Vítejte v historii novinek v dokumentaci sady Visual Studio. Toto téma obsahuje hlavní změny v dokumentaci před srpna 2020 (od července 2020). Nejnovější novinky najdete v tématu [dokumentace k Visual Studiu: co je nového v dokumentaci](whats-new-visual-studio-docs.md).
