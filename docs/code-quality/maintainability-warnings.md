...
| [CA1507: místo řetězce použijte nameof.](../code-quality/ca1507.md) | Řetězcový literál se používá jako argument, ve kterém by bylo možné použít výraz `nameof`. |
