...
Všimněte si, že toto pravidlo je porušené, když se metoda ToString typu používá explicitně nebo implicitně k sestavení řetězce dotazu. Například:
...
Následující příklad ukazuje metodu, `UnsafeQuery`, která porušuje pravidlo a metodu, `SaferQuery`, která splňuje pravidlo pomocí parametrizovaného řetězce příkazu.
