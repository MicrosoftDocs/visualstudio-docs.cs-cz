---
title: 'CA2322: Ujistěte se, že se pro SimpleTypeResolver před deserializací neinicializuje JavaScriptSerializer.'
ms.date: 05/08/2019
ms.topic: reference
author: dotpaul
ms.author: paulming
...
ms.locfileid: "74809445"
---
# <a name="ca2322-ensure-javascriptserializer-is-not-initialized-with-simpletyperesolver-before-deserializing"></a>CA2322: Ujistěte se, že se pro SimpleTypeResolver před deserializací neinicializuje JavaScriptSerializer.
...
Byla volána nebo odkazována metoda deserializace <xref:System.Web.Script.Serialization.JavaScriptSerializer?displayProperty=nameWithType>a a <xref:System.Web.Script.Serialization.JavaScriptSerializer> mohla být inicializována <xref:System.Web.Script.Serialization.SimpleTypeResolver?displayProperty=nameWithType>.
...
Toto pravidlo vyhledá <xref:System.Web.Script.Serialization.JavaScriptSerializer?displayProperty=nameWithType> volání metody deserializace nebo odkazy, pokud <xref:System.Web.Script.Serialization.JavaScriptSerializer> mohla být inicializována pomocí <xref:System.Web.Script.Serialization.SimpleTypeResolver?displayProperty=nameWithType>.

## <a name="how-to-fix-violations"></a>Jak opravit porušení

- Ujistěte se, že <xref:System.Web.Script.Serialization.JavaScriptTypeResolver?displayPropertyName=nameWithType> objekty nejsou inicializovány pomocí <xref:System.Web.Script.Serialization.SimpleTypeResolver?displayProperty=nameWithType>.
...
[CA2321: Neprovádějte deserializaci se službou JavaScriptSerializer pomocí SimpleTypeResolver](ca2321.md)
