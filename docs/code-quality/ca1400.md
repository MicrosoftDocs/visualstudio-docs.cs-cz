...
Následující příklad ukazuje typ, který je v rozporu s pravidlem. V knihovně Kernel32. dll není k dispozici žádná funkce s názvem `DoSomethingUnmanaged` .
