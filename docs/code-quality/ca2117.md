...
description: Veřejný nebo chráněný typ v sestavení s atributem System. Security. AllowPartiallyTrustedCallersAttribute dědí z typu deklarovaného v sestavení, které nemá atribut.
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
- CA2117
