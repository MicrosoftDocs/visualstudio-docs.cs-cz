...
- Nahraďte argument <xref:System.Xml.XmlResolver> hodnotou null nebo instance <xref:System.Xml.XmlSecureResolver>.
...
### <a name="violationmdashdocument-function-and-script-execution-not-disabled"></a>Porušení funkce dokumentu&mdash;a spuštění skriptu není zakázané.
