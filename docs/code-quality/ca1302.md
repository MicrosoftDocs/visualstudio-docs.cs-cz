...
Pokud se řetězcový literál nepoužívá k odkazování na jedno ze systémových umístění, které je přidruženo k <xref:System.Environment.SpecialFolder> výčtu, je bezpečné potlačit upozornění od tohoto pravidla.
