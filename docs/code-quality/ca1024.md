...
Ladicímu programu můžete zabránit v automaticky rozbalování vlastností, a to použitím <xref:System.Diagnostics.DebuggerBrowsableAttribute?displayProperty=fullName> . Následující příklad ukazuje tento atribut aplikovaný na vlastnost instance.
