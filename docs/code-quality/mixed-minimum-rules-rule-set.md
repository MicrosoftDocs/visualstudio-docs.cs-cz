...
ms.locfileid: "81649322"
---
# <a name="mixed-minimum-rules-rule-set"></a>Sada pravidel Smíšená minimální pravidla

Smíšená minimální pravidla společnosti Microsoft se zaměřují na nejdůležitější problémy v projektech jazyka C++, které podporují prostředí Common Language Runtime, včetně potenciálních bezpečnostních děr a selhání aplikací.
