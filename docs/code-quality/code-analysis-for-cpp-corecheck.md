...
[C26448 USE_GSL_FINALLY](c26448.md) Zvažte použití `gsl::finally`, pokud je konečná akce určena. Zobrazit [C++ Core Guidelines: GSL.util: nástroje](https://github.com/isocpp/CppCoreGuidelines/blob/master/CppCoreGuidelines.md#SS-utilities).
