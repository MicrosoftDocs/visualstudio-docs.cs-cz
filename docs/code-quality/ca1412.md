...
<xref:System.Runtime.InteropServices.ComSourceInterfacesAttribute> slouží k identifikaci rozhraní události, které třída zveřejňuje pro klienty modelu COM (Component Object Model). Tato rozhraní musí být vystavena jako `InterfaceIsIDispatch`, aby Visual Basic 6 klientů COM umožnila přijímat oznámení o událostech. Ve výchozím nastavení, pokud rozhraní není označeno atributem <xref:System.Runtime.InteropServices.InterfaceTypeAttribute>, je vystaveno jako duální rozhraní.

## <a name="how-to-fix-violations"></a>Jak opravit porušení

Chcete-li opravit porušení tohoto pravidla, přidejte nebo upravte atribut <xref:System.Runtime.InteropServices.InterfaceTypeAttribute> tak, aby byla jeho hodnota nastavena na hodnotu InterfaceIsIDispatch pro všechna rozhraní, která jsou zadána s atributem <xref:System.Runtime.InteropServices.ComSourceInterfacesAttribute>.
