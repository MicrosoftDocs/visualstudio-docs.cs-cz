---
title: 'CA2016: Přeposlat parametr CancellationToken metodám, které ho přijmou'
ms.date: 06/18/2020
ms.topic: reference
f1_keywords:
...
ms.locfileid: "90098760"
---
# <a name="ca2016-forward-the-cancellationtoken-parameter-to-methods-that-take-one"></a>CA2016: Přeposlat parametr CancellationToken metodám, které ho přijmou
...
> [!NOTE]
> Pravidlo CA2016 je k dispozici ve všech verzích rozhraní .NET, kde `CancellationToken` je daný typ k dispozici. Viz [CancellationToken oddílu "platí pro"](/dotnet/api/system.threading.cancellationtoken#moniker-applies-to) .
