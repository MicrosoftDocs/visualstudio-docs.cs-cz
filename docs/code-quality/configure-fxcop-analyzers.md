...
ms.locfileid: "90560759"
---
# <a name="configure-net-code-quality-analyzers-with-editorconfig"></a>Konfigurace analyzátorů kvality kódu .NET pomocí EditorConfig

Od .NET 5,0 jsou analyzátory kvality kódu ([ `CAxxxx` pravidla](code-analysis-for-managed-code-warnings.md)) součástí [sady .NET SDK](/dotnet/fundamentals/productivity/code-analysis.md/#code-quality-analysis). Každý analyzátor kvality kódu je možné upravit tak, aby se mohl vztahovat na části vašeho základu kódu prostřednictvím konfigurovatelných možností. Každá možnost je určena přidáním páru klíč-hodnota k souboru [EditorConfig](https://editorconfig.org) . Konfigurační soubor může být specifický pro soubor, projekt, řešení nebo celé úložiště.
...
## <a name="options-for-net-code-quality-analyzers"></a>Možnosti pro analyzátory kvality kódu .NET
