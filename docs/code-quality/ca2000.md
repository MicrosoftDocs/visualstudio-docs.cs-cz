...
- Metoda, která vyvolala upozornění vrátí objekt <xref:System.IDisposable>, který zabalí váš objekt.
...
- `port`, která se používá pro návratovou hodnotu metody.
