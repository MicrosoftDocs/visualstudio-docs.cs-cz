...
Chcete-li opravit porušení tohoto pravidla, označte metodu přístupu atributem <xref:System.Security.SecurityCriticalAttribute> nebo <xref:System.Security.SecuritySafeCriticalAttribute> nebo odeberte LinkDemand z metody přístupu.
