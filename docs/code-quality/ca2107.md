...
- Hodnoty, které se používají k vytvoření oprávnění založeného na cestách, je obvykle možné zadat několika způsoby. Odepření přístupu k jedné z těchto cest neodepře přístup všem formulářům. Pokud je například sdílená složka \\\Server\Share namapována na síťovou jednotku X:, chcete-li odepřít přístup k souboru ve sdílené složce, je nutné zamítnout \\\Server\Share\File, X:\File a každou jinou cestu, která má k souboru přístup.
