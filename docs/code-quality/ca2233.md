...
Metoda v následujícím příkladu zpracovává celé číslo, které toto pravidlo porušuje. @no__t – 0 vyžaduje, aby byla možnost **Odebrat** přetečení celého čísla pro případ požáru zakázána.
...
Zaškrtnuté bloky nejsou podporované v [!INCLUDE[vbprvb](../code-quality/includes/vbprvb_md.md)].
