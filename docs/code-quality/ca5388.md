---
title: 'CA5388: Při použití slabé funkce odvození klíče (KDF) zajistěte dostatečný počet iterací.'
...
ms.locfileid: "88250812"
---
# <a name="ca5388-ensure-sufficient-iteration-count-when-using-weak-key-derivation-function"></a>CA5388: Při použití slabé funkce odvození klíče (KDF) zajistěte dostatečný počet iterací.
