...
| [CA1838: Vyhněte se `StringBuilder` parametrům pro volání nespravovaného volání](../code-quality/ca1838.md) | Zařazování ' StringBuilder ' vždy vytvoří nativní kopii vyrovnávací paměti, což vede k vícenásobnému přidělení pro jednu operaci zařazování. |