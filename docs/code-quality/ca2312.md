...
<xref:System.Runtime.Serialization.NetDataContractSerializer?displayProperty=nameWithType>Byla volána nebo odkazována metoda deserializace a <xref:System.Runtime.Serialization.NetDataContractSerializer.Binder> vlastnost může mít hodnotu null.

Toto pravidlo je podobné [CA2311](ca2311.md), ale analýza nedokáže určit, jestli má <xref:System.Runtime.Serialization.NetDataContractSerializer.Binder> jednoznačně hodnotu null.
...
Toto pravidlo vyhledá <xref:System.Runtime.Serialization.NetDataContractSerializer?displayProperty=nameWithType> volání metody deserializace nebo odkazuje na to, kdy <xref:System.Runtime.Serialization.NetDataContractSerializer.Binder> může být null. Pokud chcete zakázat jakoukoli deserializaci <xref:System.Runtime.Serialization.NetDataContractSerializer> bez ohledu na <xref:System.Runtime.Serialization.NetDataContractSerializer.Binder> vlastnost, zakažte toto pravidlo a [CA2311](ca2311.md)a povolte pravidlo [CA2310](ca2310.md).
