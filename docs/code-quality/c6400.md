...
ms.locfileid: "72017326"
---
# <a name="c6400"></a>C6400
Upozornění C6400: Použití \<function název > k porovnání velkých a malých písmen s konstantním řetězcem \<string název >. Poskytne neočekávané výsledky v jiných než anglických národních prostředích.
