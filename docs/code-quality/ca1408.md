...
Viditelný typ modelu COM (Component Object Model) je označen atributem <xref:System.Runtime.InteropServices.ClassInterfaceAttribute> nastaveným na hodnotu `AutoDual` <xref:System.Runtime.InteropServices.ClassInterfaceType>.
...
Chcete-li opravit porušení tohoto pravidla, změňte hodnotu atributu <xref:System.Runtime.InteropServices.ClassInterfaceAttribute> na hodnotu `None` <xref:System.Runtime.InteropServices.ClassInterfaceType> a explicitně definovat rozhraní.
