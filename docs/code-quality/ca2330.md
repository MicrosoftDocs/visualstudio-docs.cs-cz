...
- Vlastnost [TypeNameHandling](https://www.newtonsoft.com/json/help/html/P_Newtonsoft_Json_JsonSerializer_TypeNameHandling.htm) je jinou hodnotou než `None`.
...
- Pokud je to možné, použijte `None` hodnotu [TypeNameHandling](https://www.newtonsoft.com/json/help/html/T_Newtonsoft_Json_TypeNameHandling.htm).
...
[CA2328: Zajistěte, aby byla JsonSerializerSettings zabezpečená.](ca2328.md)

[CA2329: Nepoužívejte neserializaci s JsonSerializer pomocí nezabezpečené konfigurace](ca2329.md)
