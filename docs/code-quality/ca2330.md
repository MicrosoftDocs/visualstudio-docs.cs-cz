...
Toto pravidlo je vyvoláno, pokud pro instanci [Newtonsoft.Json.Jsho serializace](https://www.newtonsoft.com/json/help/html/T_Newtonsoft_Json_JsonSerializer.htm) může platit obě následující podmínky:
