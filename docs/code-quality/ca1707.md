...
Potlačit upozornění pro produkční kód. Je však bezpečné potlačit toto upozornění pro testovací kód. Upozornění můžete z tohoto pravidla potlačit nastavením jeho [závažnosti](use-roslyn-analyzers.md#configure-severity-levels) na **None (žádné**).
