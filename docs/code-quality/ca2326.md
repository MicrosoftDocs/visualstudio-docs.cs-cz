...
- Je odkazována hodnota výčtu [Newtonsoft. JSON. TypeNameHandling](https://www.newtonsoft.com/json/help/html/T_Newtonsoft_Json_TypeNameHandling.htm) , která je jiná než `None` .
...
Toto pravidlo vyhledá hodnoty [Newtonsoft. JSON. TypeNameHandling](https://www.newtonsoft.com/json/help/html/T_Newtonsoft_Json_TypeNameHandling.htm) jiné než `None` . Pokud chcete deserializovat pouze v případě, že je zadán [Newtonsoft. JSON. Serialization. ISerializationBinder](https://www.newtonsoft.com/json/help/html/T_Newtonsoft_Json_Serialization_ISerializationBinder.htm) pro omezení deserializovaných typů, zakažte toto pravidlo a místo toho povolte pravidla [CA2327](ca2327.md), [CA2328](ca2328.md), [CA2329](ca2329.md)a [CA2330](ca2330.md) .
