...
description: Typ hodnoty viditelný v modelu COM je označen atributem System. Runtime. InteropServices. StructLayoutAttribute nastaveným na hodnotu LayoutKind. auto.
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
