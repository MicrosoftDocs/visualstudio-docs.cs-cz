...
Můžete nakonfigurovat, které části kódu toto pravidlo analyzuje. Další informace najdete v tématu [Konfigurace analyzátorů kvality kódu .NET](configure-fxcop-analyzers.md).
