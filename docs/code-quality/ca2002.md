...
- Pole typů hodnot, včetně [integrálních typů](/dotnet/csharp/language-reference/keywords/integral-types-table), [typů s plovoucí desetinnou čárkou](/dotnet/csharp/language-reference/keywords/floating-point-types-table)a <xref:System.Boolean>.
