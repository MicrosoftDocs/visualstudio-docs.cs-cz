---
title: 'CA2301: Nevolejte BinaryFormatter. deserializovat bez prvotního nastavení BinaryFormatter. Binder'
ms.date: 04/05/2019
ms.topic: reference
author: dotpaul
ms.author: paulming
...
ms.locfileid: "74810016"
---
# <a name="ca2301-do-not-call-binaryformatterdeserialize-without-first-setting-binaryformatterbinder"></a>CA2301: Nevolejte BinaryFormatter. deserializovat bez prvotního nastavení BinaryFormatter. Binder
...
Byla volána metoda deserializace <xref:System.Runtime.Serialization.Formatters.Binary.BinaryFormatter?displayProperty=nameWithType> nebo odkaz bez sady vlastností <xref:System.Runtime.Serialization.Formatters.Binary.BinaryFormatter.Binder>.
