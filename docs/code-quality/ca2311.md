...
Byla volána metoda deserializace <xref:System.Runtime.Serialization.NetDataContractSerializer?displayProperty=nameWithType> nebo odkaz bez sady vlastností <xref:System.Runtime.Serialization.NetDataContractSerializer.Binder>.
