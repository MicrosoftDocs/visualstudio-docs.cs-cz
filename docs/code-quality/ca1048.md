...
Veřejný typ je zapečetěn a deklaruje metodu, která je současně `virtual` (`Overridable` v Visual Basic) a nikoli finální. Toto pravidlo neoznamuje porušení pro typy delegátů, které musí následovat po tomto vzoru.
