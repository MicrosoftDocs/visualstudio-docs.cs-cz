---
title: 'CA5397: Nepoužívejte zastaralé hodnoty SslProtocols určující'
...
ms.locfileid: "75718607"
---
# <a name="ca5397-do-not-use-deprecated-sslprotocols-values"></a>CA5397: Nepoužívejte zastaralé hodnoty SslProtocols určující
...
- Celočíselná hodnota představující zastaralou hodnotu byla buď přiřazena proměnné <xref:System.Security.Authentication.SslProtocols>, použita jako návratová hodnota <xref:System.Security.Authentication.SslProtocols> nebo se používá jako argument <xref:System.Security.Authentication.SslProtocols>.
...
[CA5398: Vyhněte se hodnotám SslProtocols určující pevně zakódované](ca5398.md)
