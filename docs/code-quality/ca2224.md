...
Následující příklad ukazuje typ s nekonzistentními definicemi rovnosti. `BadPoint` mění význam rovnosti tím, že poskytuje vlastní implementaci operátoru rovnosti, ale nepřepisuje <xref:System.Object.Equals%2A>, takže se chová stejně.
