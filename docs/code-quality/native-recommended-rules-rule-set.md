...
Nativní doporučená pravidla se zaměřují na nejdůležitější a nejčastější problémy v nativním kódu, včetně potenciálních bezpečnostních děr a selhání aplikace. Tato sada pravidel zahrnuje všechna pravidla v sadě pravidel [nativní minimální pravidla.](native-minimum-rules-rule-set.md)
