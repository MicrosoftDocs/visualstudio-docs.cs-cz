---
title: 'CA3012: Přečtěte si kód pro chyby zabezpečení injektáže regulárního výrazu.'
ms.date: 04/03/2019
ms.topic: reference
author: dotpaul
ms.author: paulming
...
ms.locfileid: "74809375"
---
# <a name="ca3012-review-code-for-regex-injection-vulnerabilities"></a>CA3012: Přečtěte si kód pro chyby zabezpečení injektáže regulárního výrazu.
...
- Vložení speciálních znaků ze vstupu uživatele voláním <xref:System.Text.RegularExpressions.Regex.Escape%2A?displayProperty=fullName> nebo jiné metody.
