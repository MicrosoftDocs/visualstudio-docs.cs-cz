...
Finalizační metoda musí být šířena přes hierarchii dědičnosti. Aby bylo zajištěno, typy musí volat svou základní třídu <xref:System.Object.Finalize%2A> z vlastní metody <xref:System.Object.Finalize%2A>. C# Kompilátor automaticky přidá volání k finalizační metodě základní třídy.
...
Následující příklad Visual Basic ukazuje typ `TypeB`, který správně volá metodu <xref:System.Object.Finalize%2A> v její základní třídě.
