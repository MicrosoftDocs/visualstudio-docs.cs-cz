---
title: 'CA5389: Nepřidávat cestu archivní položky k cílové cestě systému souborů'
...
ms.locfileid: "74809349"
---
# <a name="ca5389-do-not-add-archive-items-path-to-the-target-file-system-path"></a>CA5389: Nepřidávat cestu archivní položky k cílové cestě systému souborů
...
- Cesta k parametru <xref:System.IO.FileStream?displayProperty=nameWithType> konstruktoru
- Cesta k parametru `fileName` <xref:System.IO.FileInfo?displayProperty=nameWithType>
