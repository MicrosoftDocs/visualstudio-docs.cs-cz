...
Deklarace metody Invoke platformy obsahuje parametr <xref:System.Boolean?displayProperty=fullName> nebo návratovou hodnotu, ale atribut <xref:System.Runtime.InteropServices.MarshalAsAttribute?displayProperty=fullName> se nepoužije na parametr nebo návratovou hodnotu.
