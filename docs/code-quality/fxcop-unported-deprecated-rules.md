---
description: Následující starší pravidla analýzy FxCop jsou zastaralá a nebudou implementována jako analyzátory.
title: Zastaralá pravidla
ms.date: 05/21/2019
ms.topic: reference
helpviewer_keywords:
- fxcop rules
