...
Transparentní metoda, metoda, která je označena metodou <xref:System.Security.SecuritySafeCriticalAttribute>, nebo typ, který obsahuje metodu, je označen atributem <xref:System.Security.SuppressUnmanagedCodeSecurityAttribute>.
