---
description: Následující starší pravidla analýzy FxCop ještě nebyla implementována jako analyzátory, ale přesto může být.
title: Nepřenesená pravidla, která se dají přenést
ms.date: 05/21/2019
ms.topic: reference
helpviewer_keywords:
- fxcop rules
...
ms.locfileid: "102144686"
---
# <a name="unported-rules-that-may-be-ported"></a>Nepřenesená pravidla, která se dají přenést
