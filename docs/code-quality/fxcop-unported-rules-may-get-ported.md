---
title: Neportovaná pravidla, která se dají přenést
ms.date: 05/21/2019
ms.topic: reference
helpviewer_keywords:
- fxcop rules
...
ms.locfileid: "89511090"
---
# <a name="unported-rules-that-may-be-ported"></a>Neportovaná pravidla, která se dají přenést
