...
Výjimka je vyvolána z klauzule `finally`, Filter nebo Fault.

## <a name="rule-description"></a>Popis pravidla
Je-li v klauzuli Exception vyvolána výjimka, významně se tím zvyšuje obtížnost ladění.

Pokud je výjimka vyvolána v klauzuli `finally` nebo Fault, nová výjimka skryje aktivní výjimku, pokud je k dispozici. Tím je původní chybě obtížné detekovat a ladit.
