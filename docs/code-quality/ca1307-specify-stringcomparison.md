...
Mnoho řetězcových operací, nejdůležitější metody <xref:System.String.Compare%2A> a <xref:System.String.Equals%2A>, poskytují přetížení, které přijímá hodnotu výčtu <xref:System.StringComparison> jako parametr.
