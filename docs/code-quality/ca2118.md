...
V následujícím příkladu metoda Public `DoDangerousThing` způsobí porušení. Chcete-li toto porušení vyřešit, `DoDangerousThing` by měl být privátní a přístup k němu by měl být prostřednictvím veřejné metody zabezpečené požadavkem zabezpečení, jak je znázorněno v metodě `DoWork`.
