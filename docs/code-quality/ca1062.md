...
Ve výchozím nastavení toto pravidlo analyzuje a označí `this` parametr pro metody rozšíření. Analýzu `this` parametru pro rozšiřující metody můžete vyloučit přidáním následující dvojice klíč-hodnota do souboru. editorconfig v projektu:
