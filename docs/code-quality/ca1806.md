...
- Metoda COM nebo volání nespravovaného kódu, která vrací hodnotu HRESULT nebo kód chyby, který se nikdy nepoužívá.

- Metoda LINQ, která vrací výsledek, který se nikdy nepoužil.
...
Metody LINQ se označují jako vedlejší účinky a výsledek by neměl být ignorován.

## <a name="how-to-fix-violations"></a>Jak opravit porušení

Pokud metoda A vytvoří novou instanci objektu B, který se nikdy nepoužívá, předejte instanci jako argument jiné metodě nebo přiřaďte instanci proměnné. Pokud je vytvoření objektu zbytečné, odeberte ho.
...
Pokud metoda LINQ volá metodu B, ale nepoužívá výsledek, použijte výsledek v podmíněném příkazu, přiřaďte výsledek proměnné nebo ji předejte jako argument jiné metodě.
