...
| <xref:System.ServiceModel.Activities.Receive.OperationName%2A> | Pravda | Určuje název operace služby implementované touto <xref:System.ServiceModel.Activities.Receive> aktivitou. Tato vlastnost slouží k vytvoření výchozí hodnoty pro vlastnost **Action** , pokud vlastnost **Action** není explicitně nastavena. |
