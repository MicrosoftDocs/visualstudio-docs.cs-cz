...
description: Přečtěte si, jak můžete pomocí šablony SendAndReceiveReply vytvořit dvojici předem nakonfigurovaných aktivit Send a ReceiveReply.
