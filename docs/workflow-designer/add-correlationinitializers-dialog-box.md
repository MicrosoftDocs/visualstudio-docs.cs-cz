...
description: Přečtěte si, jak můžete použít dialogové okno Přidat Inicializátory korelace ke konfiguraci vlastností Inicializátoři CorrelationInitializers aktivit odeslat, přijmout a SendReply.
