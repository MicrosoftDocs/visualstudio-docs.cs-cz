...
description: Přečtěte si, jak můžete pomocí návrháře aktivit InitializeCorrelation vytvořit a nakonfigurovat aktivitu InitializeCorrelation.
