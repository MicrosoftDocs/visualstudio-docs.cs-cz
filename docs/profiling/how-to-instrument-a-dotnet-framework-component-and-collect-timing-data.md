---
title: 'Příkazový řádek profileru: instrumentace klientské součásti .NET, získání časových údajů'
ms.date: 11/04/2016
ms.topic: conceptual
...
---
# <a name="how-to-instrument-a-stand-alone-net-framework-component-and-collect-timing-data-with-the-profiler-from-the-command-line"></a>Postupy: instrumentace samostatné součásti .NET Framework a shromažďování dat časování pomocí profileru z příkazového řádku
Toto téma popisuje, jak pomocí nástrojů příkazového řádku [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] Nástroje pro profilaci instrumentovat komponentu .NET Framework, jako je například. *exe* nebo. soubor *DLL* a shromažďování podrobných dat časování.
