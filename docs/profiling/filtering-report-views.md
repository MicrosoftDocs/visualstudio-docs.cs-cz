...
2. U každé klauzule, kterou chcete přidat do filtru, vyberte nebo zadejte hodnoty v následujících polích řádku.
    ...
    |**Dílčí**|Vyberte pole sestavy, které chcete použít v klauzuli Filter ze zobrazeného seznamu datových polí.|
    |**Podnikatel**|Vyberte operátor, který určuje vztah, který chcete v klauzuli mezi polem a hodnotou.<br /><br /> = Equals<br /><br /> < > nerovná se<br /><br /> < Menší než<br /><br /> > Větší než<br /><br /> < = menší než nebo rovno<br /><br /> > = větší než nebo rovno|
