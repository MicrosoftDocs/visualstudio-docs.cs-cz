...
Možnost **Start** je možnost *VSPerfCmd. exe* , která inicializuje Profiler na určenou metodu profilace.
 ...
 **WinCounter:** `Path` [**automark**:`n`] **WinCounter** určuje čítač výkonu systému Windows, který má být zahrnut jako znak v souboru dat profilování. **AutoMark** určuje interval v milisekundách mezi kolekcemi datového souboru.
...
## <a name="example"></a>Příklad
 Následující příklad ukazuje, jak použít možnost spuštění *VSPerfCmd. exe* pro inicializaci profileru.
