...
Tento článek popisuje, jak pomocí nástrojů příkazového řádku [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] Nástroje pro profilaci připojit profiler ke spuštěné samostatné aplikaci (C/C++) a shromažďovat data kolize vláken.
