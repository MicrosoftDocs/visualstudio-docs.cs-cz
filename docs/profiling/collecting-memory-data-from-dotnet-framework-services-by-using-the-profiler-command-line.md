...
description: Naučte se používat metodu vzorkování z příkazového řádku ke shromáždění dat o přidělování paměti a životnosti objektů pro službu .NET Framework.
