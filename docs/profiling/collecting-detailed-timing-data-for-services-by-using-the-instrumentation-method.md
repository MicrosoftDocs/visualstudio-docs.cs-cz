---
title: Příkazový řádek profileru – získání dat časování pro službu
description: Naučte se používat metodu instrumentace z příkazového řádku ke shromažďování podrobných údajů o výkonu pro služby systému Windows.
...
|**ASP.NET webové aplikace Profile**|-   [Shromažďování podrobných dat časování pomocí instrumentace](../profiling/collecting-detailed-timing-data-aspnet-profiler-instrumentation-method.md)|
