...
3. Na druhé stránce průvodce vyberte aplikaci, kterou chcete profilovat.
   ...
   - Chcete-li profilovat projekt, který je aktuálně otevřen v [!INCLUDE[vs_current_short](../code-quality/includes/vs_current_short_md.md)], vyberte možnost **jedna nebo více dostupných projektů** a potom vyberte název projektu ze seznamu.
