...
| [DA0003: Vysoký počet ukázek jádra](../profiling/da0003-many-kernel-samples.md) | Bylo zaznamenáno mnoho ukázek profilace, k nimž došlo mimo provádění cílového binárního souboru. Chcete-li shromáždit přesnější data, zvažte použití metody instrumentace. |
...
| [DA0030: Získat Měření interakce vrstev pro databázové projekty](../profiling/da0030-gather-tier-interaction-measurements-for-database-projects.md) | Byl shromážděn značný počet volání metod v oboru názvů <xref:System.Data?displayProperty=fullName>. Pokud chcete zahrnout data o voláních databáze, zvažte shromáždění dat interakce vrstev ve vašem profilu. |
