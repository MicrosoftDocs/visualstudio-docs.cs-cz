...
description: Metoda MarkProfile vloží značku profilu do souboru. vsp. Pro vložení značky musí být profilace vlákna obsahující funkci MarkProfile.
ms.date: 11/04/2016
ms.topic: conceptual
helpviewer_keywords:
- MarkProfile
