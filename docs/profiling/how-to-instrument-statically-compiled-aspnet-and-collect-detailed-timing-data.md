---
title: 'Příkazový řádek profileru: instrumentace statické aplikace ASP.NET, získání časových údajů'
ms.date: 11/04/2016
ms.topic: conceptual
...
Tento článek popisuje, jak pomocí nástrojů příkazového řádku [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] Nástroje pro profilaci instrumentovat předkompilováné [!INCLUDE[vstecasp](../code-quality/includes/vstecasp_md.md)] webové komponenty nebo webové stránky a shromažďovat podrobná data časování.
