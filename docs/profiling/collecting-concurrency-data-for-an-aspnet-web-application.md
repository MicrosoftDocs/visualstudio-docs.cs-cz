---
title: Příkazový řádek profileru pro získání dat souběžnosti webové aplikace ASP.NET
ms.date: 11/04/2016
ms.topic: conceptual
helpviewer_keywords:
...
Metoda souběžnosti [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] Nástroje pro profilaci umožňuje shromažďovat data kolize prostředků.
