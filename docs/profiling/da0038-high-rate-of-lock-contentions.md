...
description: Data o výkonu systému shromážděná s daty profilace znamenají, že během provádění aplikace došlo k výraznému vysokému podílu kolizí zámků.
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
- vs.performance.38
