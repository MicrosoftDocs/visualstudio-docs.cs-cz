...
- Další informace o aktivitách programovací model Windows Workflow Foundation najdete v tématu [obor názvů System. Workflow. Activities](/dotnet/api/system.workflow.activities&view=netframework-4.8).
