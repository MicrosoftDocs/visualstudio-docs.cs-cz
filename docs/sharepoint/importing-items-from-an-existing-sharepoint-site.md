...
description: Import položek z existujícího webu služby SharePoint pomocí šablony projektu importovat balíček řešení služby SharePoint, takže můžete znovu použít prvky v novém řešení služby SharePoint.
