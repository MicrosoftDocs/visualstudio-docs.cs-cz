...
Pokud chcete tuto image použít pro pracovní postup CI/CD, můžete ji publikovat do vlastního [Azure Container Registry](https://azure.microsoft.com/services/container-registry) nebo jiného interního registru [Dockeru,](https://docs.docker.com/registry/deploying) aby je servery potřebovaly jenom vyžádat.
