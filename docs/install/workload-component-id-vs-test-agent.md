---
title: Visual Studio ID komponent a úloh testovacího agenta
titleSuffix: ''
description: Použití Visual Studio ID úloh a komponent ke vzdálenému spouštění automatizovaných testů a zátěžových testů
keywords: ''
author: j-martens
ms.author: jmartens
manager: jmartens
...
ms.locfileid: "110449642"
---
# <a name="visual-studio-test-agent-component-directory"></a>Visual Studio adresáře komponent agenta test
