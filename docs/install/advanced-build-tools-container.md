...
Po dokončení provádění posledního řádku otevřete na svém počítači "% TEMP% \vslogs.zip" nebo na webu [komunity vývojářů](https://aka.ms/feedback/suggest?space=8) dejte problém.
