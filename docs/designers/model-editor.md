...
2. Na panelu nástrojů **editoru modelů** vyberte možnosti **skripty**–  >    >  **vytlačení**.
...
2. Na panelu nástrojů **editoru modelů** vyberte možnost   >    >  **rozdělit** nástroje skriptů.
...
2. Na panelu nástrojů **editoru modelů** vyberte nástroje **skripty**  >    >  **triangulovat**.

#### <a name="merge-objects"></a>Sloučit objekty

1. V režimu výběru objektů vyberte objekty, které chcete sloučit.

2. Na panelu nástrojů **editoru modelů** vyberte nástroje **skripty**  >    >  **Sloučit objekty**.
...
2. Na panelu nástrojů **editoru modelů** vyberte možnost   >  **nástroje** skripty  >  **vytvořit nový objekt z mnohoúhelníkového výběru**.
...
|Přepnout do režimu **posouvání**|**CTRL** + **G**, **CTRL** +  +<br /><br /> **K**|
|Vybrat vše|**CTRL** + **A**|
...
|Vybrat další objekt na scéně|**Tab**|
