---
title: Uzly nástroje
description: Přečtěte si o uzlech nástrojů v Návrháři shaderu, který představuje běžné, užitečné výpočty shaderu, které se nevejdou do ostatních kategorií.
