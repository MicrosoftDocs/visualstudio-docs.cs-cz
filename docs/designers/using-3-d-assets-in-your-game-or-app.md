...
description: Naučte se používat Visual Studio ke zpracování 3D prostředků a jejich zahrnutí do sestavení. Visual Studio poskytuje přizpůsobení sestavení pro každý Asset, který vytváří.
