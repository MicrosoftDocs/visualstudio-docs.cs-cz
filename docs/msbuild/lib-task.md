...
|**Jméno**|Volitelný **řetězcový** parametr.<br /><br /> Při sestavení knihovny importů Určuje název knihovny DLL, pro kterou se knihovna importů sestavuje.<br /><br /> Tento parametr odpovídá parametru **/Name** souboru *lib. exe* , který přebírá `filename` argument.|
