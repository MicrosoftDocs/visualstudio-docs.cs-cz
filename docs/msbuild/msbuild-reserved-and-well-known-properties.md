...
| `MSBuildInteractive` | Vyhrazeno | `true`, pokud MSBuild běží interaktivně, což umožňuje vstup uživatele. Toto nastavení je řízeno možností `-interactive` příkazového řádku. |
