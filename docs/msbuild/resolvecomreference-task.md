...
description: Přečtěte si, jak MSBuild používá úlohu ResolveComReference – k převzetí seznamu jednoho nebo více názvů knihoven typů nebo souborů. tlb a jejich řešení na umístění na disku.
