...
Zabalí nástroj Microsoft C++ Compiler Tool, Clang. exe.
...
|**MSCompatibility**|Volitelný parametr **bool** .<br/><br/>Zapněte plnou C++ kompatibilitu Microsoftu.|
...
|**Vybrané**|Volitelný **řetězcový** parametr.<br/><br/>Určuje úroveň optimalizace pro aplikaci.<br/><br/>**Vlastní**a vlastní optimalizace.<br/>**Zakázáno**, zakázat optimalizaci (použijte `O0`).<br/>**MinSize**, optimalizovat pro velikost (použijte `Os`).<br/>**MaxSpeed**, optimalizujte pro rychlost (použijte `O2`).<br/>**Plná**a náročná optimalizace (použijte `O3`).|
...
|**ThumbMode**|Volitelný **řetězcový** parametr.<br/><br/>Vygeneruje kód, který se spustí pro mikroarchitekturu pro palec. To platí jenom pro architekturu ARM.<br/><br/>**, Vygenerujte kód pro palec (** použijte `mthumb`).<br/>**ARM**, vygenerujte kód ARM (použijte `marm`).<br/>Možnost **disabled**se pro zvolenou platformu nedá použít.|
