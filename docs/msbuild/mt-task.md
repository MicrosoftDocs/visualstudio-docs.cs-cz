...
|**Prostředky**|Volitelný `ITaskItem[]` parametr.<br /><br /> Určuje seznam zdrojových souborů manifestu oddělených mezerami.<br /><br /> Další informace naleznete v možnosti **/manifest** v [Mt.exe](/windows/desktop/SbsCs/mt-exe).|
