...
## <a name="c-project-vcxproj-and-solution-sln-files"></a>C++soubory projektu (. vcxproj) a řešení (. sln)
 ...
 Do C++ [úlohy MSBuild](../msbuild/msbuild-task.md)lze předat jak projekty ( *. vcxproj*), tak soubory řešení ( *. sln*). Pro C++ projekty se zavolá VCWrapperProject a pak se vytvoří interní projekt MSBuild. Pro C++ řešení se vytvoří SolutionWrapperProject a pak se vytvoří interní projekt MSBuild. V obou případech je výsledný projekt zpracován stejně jako jakýkoli jiný projekt MSBuild.
