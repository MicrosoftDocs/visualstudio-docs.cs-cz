...
Úloha <xref:Microsoft.Build.Tasks.Windows.MergeLocalizationDirectives> sloučí atributy lokalizace a komentáře jednoho nebo více souborů binárního formátu XAML do jednoho souboru pro celé sestavení.
