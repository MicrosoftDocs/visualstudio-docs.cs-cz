...
Úloha <xref:Microsoft.Build.Tasks.Windows.MarkupCompilePass1> převede nelokalizovatelné soubory projektu XAML na kompilovaný binární formát.
...
Soubor XAML odkazuje na místně definovaný typ při deklaraci oboru názvů XML, který používá hodnotu `clr-namespace` pro odkazování na obor názvů v aktuálním projektu:
