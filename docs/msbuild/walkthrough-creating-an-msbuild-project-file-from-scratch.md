...
description: Projděte si vytvoření souboru projektu MSBuild od začátku, abyste porozuměli tomu, jak je kód XML uspořádaný a jak jej lze změnit pro řízení sestavení.
