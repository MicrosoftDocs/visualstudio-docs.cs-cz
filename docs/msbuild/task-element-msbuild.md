...
## <a name="remarks"></a>Poznámky
 ...
 Pokud v nadřazeném [](../msbuild/onerror-element-msbuild.md) elementu úlohy existují nějaké prvky Error `Target` , budou vyhodnoceny i v případě, že úloha selže a `ContinueOnError` má hodnotu `false` . Další informace o úlohách najdete v tématu [úlohy](../msbuild/msbuild-tasks.md).
