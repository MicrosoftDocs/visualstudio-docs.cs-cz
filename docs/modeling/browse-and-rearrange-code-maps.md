...
- Podívejte se na clustery s přirozenými závislostmi v kódu. Na panelu nástrojů Mapa klikněte na **Layout**tlačítko rozložení **, rychlé clustery** ![ rychlé clustery na panelu nástrojů grafu ](../modeling/media/quickclustersicon.gif) . Viz [Změna rozložení mapy](#Selecting).
...
2. Pokud je element nebo odkaz součástí skupiny, **Refetch Children** ![ ](../modeling/media/dependencygraph_deletednodesicon.png) zobrazí se v rámci skupiny tlačítko znovu načíst podřízené položky. Kliknutím na tuto položku načtěte chybějící prvky a odkazy.
