...
|Změna rozložení v rámci skupiny nezávisle na ostatních uzlech a skupinách na mapě.|Vyberte uzel a otevřete místní nabídku. Zvolte **rozložení** a vyberte styl rozložení.<br /><br /> ani<br /><br /> Vyberte uzel a rozbalte ho pro zobrazení podřízených uzlů. Kliknutím na název uzlu zobrazíte místní panel nástrojů pro skupinu a otevřete okno **změnit styl rozložení** skupiny grafu &#45; závislostí![rozložení panelu nástrojů &#45;](../modeling/media/dependencygraph_grouptoolbar.gif) seznamu. Vyberte jedno z rozložení stromové struktury, **rychlé clustery**nebo **zobrazení seznamu** (které uspořádá obsah skupiny do seznamu).<br /><br /> Další podrobnosti najdete v tématu [skupiny uzlů](#OrganizeGroups) .|
...
|Změňte velikost a přizpůsobte mapu do svého okna.|Vyberte možnost **přizpůsobit tak, aby se vešla** do seznamu **zvětšení** na panelu nástrojů mapa kódu.<br /><br /> ani<br /><br /> Na panelu nástrojů mapa](../modeling/media/almcodemapzoomicon.png) na panelu nástrojů mapa kódu klikněte na ikonu **přiblížení k** umístění ![ikona zvětšení. Klávesnice: stiskněte **kombinaci kláves CTRL + 0** (nula).|
...
|Zobrazit skryté uzly.|– Chcete-li zobrazit všechny skryté uzly ve skupině, nejprve se ujistěte, že je skupina rozbalená. Otevřete místní nabídku a zvolte **možnost vybrat**, **Zobrazit podřízené položky**.<br />     ani<br />     V levém horním rohu skupiny klikněte na ikonu **Zobrazit podřízené**![zobrazit podřízené položky](../modeling/media/dependencygraph_filtericon_hiddennodes.gif) ikona (Tato možnost se zobrazí jenom v případě, že existují skryté podřízené uzly).<br />– Chcete-li zobrazit všechny skryté uzly, otevřete místní nabídku pro mapu nebo uzel a zvolte **možnost vybrat**, **Zobrazit vše**.|
...
|Změna rozložení v rámci skupiny.|Vyberte skupinu, otevřete místní nabídku, zvolte možnost **rozložení**a vyberte požadovaný styl rozložení.<br /><br /> ani<br /><br /> 1. Vyberte skupinu a ujistěte se, že je rozbalená.<br />2. klikněte znovu na záhlaví skupiny a zobrazí se panel nástrojů skupina.<br />     ](../modeling/media/dependencygraph_group.png) panel nástrojů &#45; pro skupinu grafu závislostí ![<br />3. Otevřete položku **změnit styl rozložení seznamu skupin** grafu &#45; ![závislost na panelu nástrojů &#45;](../modeling/media/dependencygraph_grouptoolbar.gif) a vyberte požadovaný styl rozložení.<br /><br /> **Zobrazení seznamu** změní uspořádání členů skupiny na seznam. **Graph – výchozí** obnoví rozložení skupiny na výchozí rozložení mapy. Další možnosti najdete v tématu [Změna rozložení mapy](#Selecting).|
