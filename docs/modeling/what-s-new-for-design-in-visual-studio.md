...
## <a name="a-nameversionsupport-edition-support-for-architecture-and-modeling-tools"></a>Podpora <a name="VersionSupport" />Edition pro architektury a nástroje pro modelování
...
|**Zapnut**|**Edice Enterprise**|**Professional Edition**|**Edice Community**|
|-|-|-|-|
