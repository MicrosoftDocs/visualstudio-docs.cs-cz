...
description: V nasazení ClickOnce je vyžadován element assemblyIdentity. Neobsahuje žádné podřízené elementy a má atributy popsané v tomto článku.
