...
description: Přečtěte si, jak můžete spouštět verze systém Microsoft Office řešení, které byly vytvořeny pomocí sady Visual Studio 2010 nebo vyšší.
