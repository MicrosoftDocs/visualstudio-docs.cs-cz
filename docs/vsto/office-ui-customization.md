...
## <a name="actions-panes-and-custom-task-panes"></a><a name="Actions"></a>Podokna akcí a vlastní podokna úloh
...
## <a name="custom-ribbon-ui"></a><a name="Ribbon"></a>Uživatelské rozhraní vlastního pásu karet
...
## <a name="backstage-view"></a><a name="Backstage"></a>Zobrazení Backstage
