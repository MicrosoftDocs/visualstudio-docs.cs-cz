...
description: Informace o ukládání a úpravách připojovacích řetězců v aplikacích sady Visual Studio. Uložení nebo úprava připojovacího řetězce přímo v nastavení aplikace.
