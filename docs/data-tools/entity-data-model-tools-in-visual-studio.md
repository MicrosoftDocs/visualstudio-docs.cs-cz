...
Nástroje generují nebo upravují soubor *. edmx* . Tento soubor *. edmx* obsahuje informace, které popisují koncepční model, model úložiště a mapování mezi nimi. Další informace naleznete v tématu [EDMX](https://docs.microsoft.com/ef/ef6/).
...
| [Dokumentace k Entity Framework (EF)](https://docs.microsoft.com/ef/ef6/get-started) | Poskytuje rejstřík videí, výukových kurzů a pokročilých dokumentů, které vám pomůžou vydávat maximum z Entity Framework. |
