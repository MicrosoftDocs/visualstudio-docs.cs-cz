...
Pojďme nakonfigurovat Visual Studio na použití nastavení prostředí přizpůsobeného pro vývojáře v jazyce C#.
...
4. Na stránce **Výběr výchozí kolekce nastavení** zvolte **Visual C#** a pak zvolte **Dokončit**.
