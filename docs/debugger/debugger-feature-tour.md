...
V tomto příkladu `DirectoryInfo` volání vrátilo chybu v prázdném řetězci uloženém v proměnné `value`.
...
> [!NOTE]
> Pomocník výjimek nahradil pomocníka výjimky od [!include[vs_dev15](../misc/includes/vs_dev15_md.md)].
