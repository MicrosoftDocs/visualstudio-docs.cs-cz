...
description: Zjistěte, které výrazy jazyka nejsou v ladicím programu sady Visual Studio podporovány v nástroji pro vyhodnocení výrazu.
...
|**Hledání řetězců**|[strchr, wcschr](/cpp/c-runtime-library/reference/strchr-wcschr-mbschr-mbschr-l), [memchr, wmemchr](/cpp/c-runtime-library/reference/memchr-wmemchr), [strstr, wcsstr](/cpp/c-runtime-library/reference/strstr-wcsstr-mbsstr-mbsstr-l)|
