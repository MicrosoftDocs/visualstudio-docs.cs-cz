---
description: Načte podřízené položky symbolu. Místní symboly, které jsou vráceny, obsahují informace o živém rozsahu, pokud je program zkompilován s optimalizací na.
