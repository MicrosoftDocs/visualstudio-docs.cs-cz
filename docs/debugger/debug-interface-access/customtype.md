...
ms.locfileid: "72745378"
---
# <a name="customtype"></a>CustomType
Typy definované dodavatelem (typy specifické pro kompilátor) jsou označeny symbolem `SymTagCustomType`.
...
|[IDiaSymbol::get_symTag](../../debugger/debug-interface-access/idiasymbol-get-symtag.md)|`DWORD`|Vrátí `SymTagCustomType` (jedna z hodnot [výčtu SymTagEnum –](../../debugger/debug-interface-access/symtagenum.md) ).|
