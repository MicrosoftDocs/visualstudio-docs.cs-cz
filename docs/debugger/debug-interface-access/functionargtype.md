...
ms.locfileid: "85468614"
---
# <a name="functionargtype"></a>FunctionArgType
Každý parametr funkce je identifikován `SymTagFunctionArgType` symbolem.
...
|[IDiaSymbol::get_symTag](../../debugger/debug-interface-access/idiasymbol-get-symtag.md)|`DWORD`|Vrátí `SymTagFunctionArgType` (jednu z hodnot [výčtu SymTagEnum –](../../debugger/debug-interface-access/symtagenum.md) ).|
