...
description: Vyhledejte informace o typu symbolu bloku (SymTagBlock), který identifikuje vnořené obory v rámci funkcí v sadě Visual Studio Debug Interface Access SDK.
