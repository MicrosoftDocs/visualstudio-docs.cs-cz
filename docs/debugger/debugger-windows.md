...
|Sledovací|CTRL + ALT + W, (1, 2, 3, 4)|[Okna Kukátko a Rychlé kukátko](../debugger/watch-and-quickwatch-windows.md)|
...
|Projev|CTRL + ALT + I|[Příkazové podokno](../ide/reference/immediate-window.md)|
...
|Úkoly|CENTRUM: + SHIFT + D, K|[Použití okna úloh](../debugger/using-the-tasks-window.md)|
...
|Rezident|CTRL + ALT + M, (1, 2, 3, 4)|[Okna paměti](../debugger/memory-windows.md)|
