...
## <a name="BKMK_COMServerandContainerintheSameSolution"></a>Ladění serveru a kontejneru modelu COM ve stejném řešení
...
## <a name="BKMK_ServerApplicationWithoutContainerInformation"></a>Ladění serverové aplikace bez informací o kontejneru
...
## <a name="BKMK_DebuggingaServerandDomainIsolationSDIApplication"></a>Ladění aplikace pro izolaci serverů a domén (SDI)
