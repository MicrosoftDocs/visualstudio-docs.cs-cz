...
Nástroje, které je třeba použít v [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] závislosti na typu kódu, který se pokoušíte ladit:
...
- Pro kód, který používá <xref:System.Threading.Tasks.Task> v [knihovně Task Parallel Library (TPL)](/dotnet/standard/parallel-programming/task-parallel-library-tpl), [Concurrency Runtime](/cpp/parallel/concrt/concurrency-runtime/) (nativní kód), jsou primární nástroje pro ladění vícevláknových aplikací okno **paralelní zásobníky** , okno **paralelní kukátko** a okno **úlohy** (okno **úlohy** také podporuje objekt Promise JavaScriptu).
