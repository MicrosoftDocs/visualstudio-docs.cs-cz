...
description: Nastavení názvu vlákna v nativním kódu během ladění vícevláknových aplikací v sadě Visual Studio. Pojmenování vláken slouží k udržení přehledu o vláknech v okně vláken.
