---
title: Zastavit změny kódu | Microsoft Docs
description: Pochopte, jak zastavit použití změn kódu při použití funkce upravit a pokračovat během relace ladění sady Visual Studio.
