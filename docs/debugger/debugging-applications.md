...
|||
|-|-|
|[Ladění aplikací pro UWP](../debugger/debugging-windows-store-and-windows-universal-apps.md)|Popisuje, jak ladit aplikace pro UWP.|
...
|[Ladění aplikací JavaScript a TypeScript](/javascript/debug-nodejs)|Popisuje, jak ladit aplikace JavaScript, TypeScript a Node. js.|
