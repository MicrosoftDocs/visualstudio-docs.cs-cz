...
V [podpoře více verzí sady Visual Studio](../../extensibility/supporting-multiple-versions-of-visual-studio.md)si můžete přečíst informace o výhodách a potížích s podporou souběžných instalací [!INCLUDE[vsprvs](../../code-quality/includes/vsprvs_md.md)] s využitím sdílených nebo souběžných instalací sady VSPackage. U krátkých souběžných rozhraní VSPackage získáte největší flexibilitu při podpoře nových funkcí [!INCLUDE[vsprvs](../../code-quality/includes/vsprvs_md.md)].
