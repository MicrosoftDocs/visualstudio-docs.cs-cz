...
|Prvek|Definováno v této části příkazové tabulky|Může být obsažen (jako rodič, nebo `CommandPlacements` umístěním v sekci, nebo obojí)|Může obsahovat (označované jako rodič)|
|-------------| - | - | - |
