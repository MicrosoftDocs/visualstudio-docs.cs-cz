...
description: Naučte se používat nástroj RegPkg.exe v aplikaci Visual Studio k vygenerování informací registru VSPackage pro začlenění v instalačním balíčku Instalační služby systému Windows.
