...
## <a name="command-menu-access"></a>Přístup k nabídce příkazů
 V testovacích případech se používá následující [!INCLUDE[vsprvs](../../code-quality/includes/vsprvs_md.md)] cesta nabídky integrovaného vývojového prostředí.
