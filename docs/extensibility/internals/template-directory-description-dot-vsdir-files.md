...
| Description | Lokalizovaný Popis souboru šablony nebo průvodce. Toto pole může být řetězec nebo identifikátor prostředku ve formátu "#ResID". Tento řetězec se zobrazí v dialogovém okně **Nový projekt** nebo **Přidat novou položku** , pokud je položka vybrána. |
