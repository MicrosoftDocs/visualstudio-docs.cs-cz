...
description: Prvek nabídky definuje jednu položku nabídky. Typy nabídek jsou kontext, nabídka, MenuController, MenuControllerLatched, panel nástrojů a ToolWindowToolbar.
