...
4. Po kliknutí na toto tlačítko by se měly odfiltrovat všechny soubory a měly by se zobrazit **všechny položky, které byly filtrovány ze zobrazení.** v **Průzkumník řešení**.
