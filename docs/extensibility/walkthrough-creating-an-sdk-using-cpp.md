...
2. V seznamu šablon rozbalte rozšíření **Visual C#**  >  **Extensibility**a pak vyberte **projekt VSIX**. Do pole **název** zadejte **NativeMathVSIX**a poté klikněte na tlačítko **OK** .
