---
title: IEnumDebugObjects::Další | Dokumenty společnosti Microsoft
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
...
`rgelt`\
[dovnitř, ven] Pole [iDebugObject](../../../extensibility/debugger/reference/idebugobject.md) prvky, které mají být vyplněny.
