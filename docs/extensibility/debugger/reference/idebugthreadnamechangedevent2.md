---
description: Toto rozhraní se odesílá ladicím modulem (DE) do Správce ladění relace (SDM), když se v laděném programu změní název vlákna.
