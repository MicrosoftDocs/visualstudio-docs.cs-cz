---
description: Vrátí další sadu prvků z výčtu vázaných zarážek.
...
`rgelt`\
[in, out] Pole [IDebugBoundBreakpoint2](../../../extensibility/debugger/reference/idebugboundbreakpoint2.md) prvků, které se mají vyplnit
