---
title: IDebugProperty3::GetStringCharLength | Dokumenty společnosti Microsoft
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
...
Tato metoda se obvykle používá jako předehra k přidělení vyrovnávací paměti pro volání [GetStringChars](../../../extensibility/debugger/reference/idebugproperty3-getstringchars.md) metody.
