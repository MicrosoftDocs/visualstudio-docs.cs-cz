---
title: IDebugSymbolProvider::GetTypeByName | Dokumenty společnosti Microsoft
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
...
`ppField`\
[out] Vrátí typ symbolu jako objekt [IDebugField.](../../../extensibility/debugger/reference/idebugfield.md)
