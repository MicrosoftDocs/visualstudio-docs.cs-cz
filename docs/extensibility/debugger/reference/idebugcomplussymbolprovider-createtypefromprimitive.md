---
description: Vytvoří typ ze zadaného primitivního typu.
...
`ppType`\
pro Vrátí objekt [IDebugField](../../../extensibility/debugger/reference/idebugfield.md) , který popisuje typ.
