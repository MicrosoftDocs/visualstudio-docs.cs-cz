---
title: IDebugDynamicFieldCOMPlus::GetTypeFromTypeDef | Dokumenty společnosti Microsoft
ms.date: 11/04/2016
ms.topic: reference
helpviewer_keywords:
- GetTypeFromTypeDef
...
`ppType`\
[out] Vrátí objekt [IDebugField,](../../../extensibility/debugger/reference/idebugfield.md) který obsahuje typ.
