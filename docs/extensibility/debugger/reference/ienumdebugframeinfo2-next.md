---
title: IEnumDebugFrameInfo2::Další | Dokumenty společnosti Microsoft
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
...
`rgelt`\
[dovnitř, ven] Pole [frameinfo](../../../extensibility/debugger/reference/frameinfo.md) prvků, které mají být vyplněny.
