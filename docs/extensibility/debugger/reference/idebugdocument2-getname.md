---
title: IDebugDocument2::GetName | Dokumenty společnosti Microsoft
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
...
## <a name="remarks"></a>Poznámky
 Tato metoda může například vrátit název dokumentu jako název nebo jako název souboru nebo dokonce část názvu souboru.
