---
title: IDebugPropertyField::GetPropertyGetter | Dokumenty společnosti Microsoft
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
...
`ppField`\
[out] Vrátí objekt [IDebugMethodField](../../../extensibility/debugger/reference/idebugmethodfield.md) představující metodu, která získá vlastnost.
