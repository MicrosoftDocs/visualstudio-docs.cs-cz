---
title: IDebugComPlusSymbolProvider2::LoadSymbolsWithCorModule | Dokumenty společnosti Microsoft
ms.date: 11/04/2016
ms.topic: reference
helpviewer_keywords:
...
`pUnkMetadataImport`\
[v] Objekt, který obsahuje metadata symbolu ladění.
