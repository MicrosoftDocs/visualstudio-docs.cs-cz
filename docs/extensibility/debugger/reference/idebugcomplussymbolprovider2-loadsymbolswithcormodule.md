---
description: Načte symboly ladění pro daný objekt ICorDebugModule.
...
`pUnkMetadataImport`\
pro Objekt, který obsahuje metadata symbolu ladění.
