---
description: Povoluje nebo zakazuje zarážku.
...
`fEnable`\
pro Nastavte na nenulovou hodnotu ( `TRUE` ), pokud chcete povolit nebo nula ( `FALSE` ) pro vypnutí zarážky.
