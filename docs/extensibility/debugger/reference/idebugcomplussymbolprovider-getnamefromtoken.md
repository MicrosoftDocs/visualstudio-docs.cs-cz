---
description: Vrátí název přidružený k zadanému tokenu za daný objekt metadat.
...
`pMetadataImport`\
pro Objekt, který obsahuje informace metadat.

`dwToken`\
pro Token, který má být pojmenován.

`pbstrName`\
mimo Název, který odpovídá tokenu.
