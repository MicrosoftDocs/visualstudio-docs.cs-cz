---
title: IDebugBreakpointBoundEvent2::GetPendingBreakpoint | Dokumenty společnosti Microsoft
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
...
Získá čekající zarážka, která je vázána.
...
`ppPendingBP`\
[out] Vrátí objekt [IDebugPendingBreakpoint2,](../../../extensibility/debugger/reference/idebugpendingbreakpoint2.md) který představuje, že je vázána čekající zarážka.
