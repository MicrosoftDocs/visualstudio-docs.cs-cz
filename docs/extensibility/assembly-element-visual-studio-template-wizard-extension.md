...
titleSuffix: ''
description: Přečtěte si o elementu sestavení a o tom, jak Určuje název nebo silný název sestavení, které implementuje rozhraní IWizard.
