...
1. Klikněte pravým tlačítkem myši na uzel řešení v **Průzkumník řešení** a vyberte **Přidat &#124; novou položku** nebo **Přidat &#124; existující položku**.
