...
|Funkce|Podpora SDK|Poznámky k sadě SDK|Podpora NuGet|Poznámky k NuGetu|
|-------------|-----------------|---------------|-------------------|-----------------|
...
|Můžete se připojit k velkému stávajícímu komunitnímu tvůrci balíčků.|NEUŽÍVÁ SE.|Komunita je nová.|A||
|Můžete se připojit k velkému stávajícímu komunitě uživatelů balíčku.|NEUŽÍVÁ SE.|Komunita je nová.|A||
|Můžete se připojit k ekosystému partnerů (vlastní galerie, úložiště a tak dále).|NEUŽÍVÁ SE.|Mezi dostupná úložiště patří galerie sady Visual Studio, Microsoft Download Center a [!INCLUDE[win8_appstore_long](../includes/win8-appstore-long-md.md)].|A||
...
|Mechanismus podporuje automatické aktualizace správce balíčků.|NEUŽÍVÁ SE.|Sada SDK se bude revidována pomocí nástroje MSBuild.|A||
