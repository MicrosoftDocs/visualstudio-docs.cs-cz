...
|Úkol|Klíč registru|Hodnota a definice|
|----------|------------------|--------------------------|
...
|Definovat výchozí nastavení online/offline|HKEY_LOCAL_MACHINE \Software\Microsoft\VSWinExpress\14.0\help|UseOnlineHelp – zadejte `0` , pokud chcete zadat místní nápovědě, a zadejte `1` pro zadání online nápovědě.|
...
|Přepsat prioritu úlohy služby BITS|HKEY_LOCAL_MACHINE \SOFTWARE\Wow6432Node (na 64m počítači) \Microsoft\Help\v2.2|BITSPriority – použijte jednu z následujících hodnot: **popředí**, **Vysoká**, **normální**nebo **Nízká**.|
|Zakázat online (a možnost IDE online)|HKEY_LOCAL_MACHINE \SOFTWARE\Wow6432Node (na 64m počítači) \Microsoft\VisualStudio\14.0\Help|OnlineHelpPreferenceDisabled – Pokud chcete zakázat přístup k obsahu online, nastavte na hodnotu 1.|
|Zakázat správu obsahu|HKEY_LOCAL_MACHINE \SOFTWARE\Wow6432Node (na 64m počítači) \Microsoft\VisualStudio\14.0\Help|ContentManagementDisabled – nastavením na hodnotu 1 zakážete kartu **Spravovat obsah** v programu Help Viewer.|
