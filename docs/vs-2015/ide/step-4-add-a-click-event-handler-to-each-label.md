...
4. Poté stiskněte klávesu ENTER. Rozhraní IDE přidá obslužnou rutinu události Click volanou `label_Click()` kódu a připojí ji ke každému popisku ve formuláři.
