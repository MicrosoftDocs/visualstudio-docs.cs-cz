...
> [!IMPORTANT]
> Informace o tom, jak změnit cílovou verzi pro projekty v jazyce C++, naleznete v tématu [How to: Modify The Target Framework and sada nástrojů Platform](https://msdn.microsoft.com/library/031b1d54-e6e1-4da7-9868-3e75a87d9ffe).
...
## <a name="targeting-a-version-when-you-create-a-project"></a><a name="bkmk_new"></a> Cílení na verzi při vytváření projektu
...
## <a name="changing-the-target-version"></a><a name="bkmk_existing"></a> Změna cílové verze
 Pomocí následujícího postupu můžete změnit cílovou verzi .NET Framework v projektu Visual Basic, Visual C# nebo Visual F#.
...
## <a name="see-also"></a>Viz také
 [Přehled cílení na více verzí sady Visual Studio](../ide/visual-studio-multi-targeting-overview.md) [.NET Framework cílení na více verzí pro webové projekty](https://msdn.microsoft.com/library/8b8145a9-62f6-4fc4-8a83-47b0487cbe76) , které se [týkají .NET Framework řešení potíží](../msbuild/troubleshooting-dotnet-framework-targeting-errors.md) [stránky aplikací s chybami, Návrháře projektu (C#)](../ide/reference/application-page-project-designer-csharp.md) [, Návrháře projektu (Visual Basic)](../ide/reference/application-page-project-designer-visual-basic.md) [Konfigurace projektů](https://msdn.microsoft.com/library/a1489abb-6294-4f8f-b71f-2cb126393526) [Postupy: Změna cílové architektury a sady nástrojů platformy](https://msdn.microsoft.com/library/031b1d54-e6e1-4da7-9868-3e75a87d9ffe)
