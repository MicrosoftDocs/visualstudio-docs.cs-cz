...
## <a name="splitting-an-editor-window"></a>Rozdělení okna editoru
...
#### <a name="to-create-a-new-window"></a>Vytvoření nového okna
...
## <a name="see-also"></a>Viz také
 [Přizpůsobení editoru](../ide/customizing-the-editor.md) [psaní kódu](../ide/writing-code-in-the-code-and-text-editor.md) [přizpůsobení rozložení oken](../ide/customizing-window-layouts-in-visual-studio.md)
