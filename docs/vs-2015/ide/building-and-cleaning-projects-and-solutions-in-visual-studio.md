...
3. Zaškrtněte políčko  **sestavit projekty po spuštění a závislosti při spuštění** .
   ...
   - Na panelu nabídek vyberte **ladit**  >  **Spustit ladění** (F5).
...
1. Zvolte [!INCLUDE[vcprvc](../includes/vcprvc-md.md)] projekt a pak na panelu nabídek zvolte možnost **sestavení**, **pouze projekt**a jeden z následujících příkazů:
...
## <a name="see-also"></a>Viz také
 [Postupy: zobrazování, ukládání a konfigurace souborů protokolu sestavení](../ide/how-to-view-save-and-configure-build-log-files.md) [získávání](../msbuild/obtaining-build-logs-with-msbuild.md) [a sestavování](../ide/compiling-and-building-in-visual-studio.md) [porozumění konfiguracím sestavení](../ide/understanding-build-configurations.md) [ladění a vydávání konfigurací projektů](https://msdn.microsoft.com/0440b300-0614-4511-901a-105b771b236e) [odkaz na sestavení C/C++ odkazy na sestavení](https://msdn.microsoft.com/library/100b4ccf-572c-4d1f-970c-fa0bc0cc0d2d) v nástroji [příkazového řádku devenv](../ide/reference/devenv-command-line-switches.md) – [řešení a projekty](../ide/solutions-and-projects-in-visual-studio.md)
