...
Můžete rozdělit deklaraci třídy nebo struktury mezi několik deklarací pomocí `Partial` klíčového slova v Visual Basic nebo `partial` klíčového slova v jazyce Visual C#. Můžete použít libovolný počet částečných deklarací, v kolika různých zdrojových souborech chcete, nebo v jednom zdrojovém souboru. Nicméně všechny deklarace musí být ve stejném sestavení a stejném oboru názvů.
 ...
 Existují dva druhy částečných metod. V jazyce Visual C# se nazývají deklarace a implementace; v Visual Basic se nazývají deklarace a implementace.
...
> [!NOTE]
> Visual Basic používá definice částečné třídy pro oddělení sady Visual Studio – generovaný kód z uživatelsky vytvořeného kódu. Kód je rozdělen do diskrétních zdrojových souborů. Například **Návrhář formuláře Windows** definuje částečné třídy pro ovládací prvky, jako například `Form` . V těchto ovládacích prvcích byste neměli upravovat generovaný kód.
...
## <a name="example"></a>Příklad
 Chcete-li rozdělit definici třídy v Visual Basic, použijte `Partial` klíčové slovo, jak je znázorněno v následujícím příkladu.
...
## <a name="example"></a>Příklad
 Chcete-li rozdělit definici třídy v jazyce Visual C#, použijte `partial` klíčové slovo, jak je znázorněno v následujícím příkladu.
...
## <a name="see-also"></a>Viz také
 Částečné [třídy a metody](https://msdn.microsoft.com/library/804cecb7-62db-4f97-a99f-60975bd59fa1) [částečné (typ)](https://msdn.microsoft.com/library/27320743-a22e-4c7b-b0b3-53afe3607334) částečná [(metoda) (Referenční dokumentace jazyka C#)](https://msdn.microsoft.com/library/43f40242-17e0-4452-8573-090503ad3137) – [částečný](https://msdn.microsoft.com/library/7adaef80-f435-46e1-970a-269fff63b448)
