---
title: 'Postupy: hledání témat | Microsoft Docs'
ms.date: 11/15/2016
...
### <a name="to-open-the-search-tab"></a>Otevření karty Hledat

- V okně aplikace Help Viewer klikněte na kartu **Vyhledat** nebo vyberte klávesy CTRL + E.
...
3. Klikněte na klávesu ENTER.
     ...
     Hledání vrátí maximálně 200 přístupů ve výchozím nastavení a zobrazí je v oblasti výsledků hledání.

     V závislosti na obsahu se mohou zobrazit další informace o verzi pro každý výsledek.

4. Chcete-li zobrazit téma, vyberte jeho název ze seznamu výsledků.

## <a name="see-also"></a>Viz také
 [Tipy pro fulltextové vyhledávání](../ide/full-text-search-tips.md) : [logické operátory ve výrazech](../ide/logical-operators-in-search-expressions.md) hledání [Rozšířené operátory hledání ve výrazech hledání](../ide/advanced-search-operators-in-search-expressions.md) [Postupy: přizpůsobení výsledků hledání](../ide/how-to-customize-search-results.md)
