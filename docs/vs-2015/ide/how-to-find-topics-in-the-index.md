---
title: 'Postupy: hledání témat v indexu | Microsoft Docs'
ms.date: 11/15/2016
...
1. Na kartě **index** proveďte jednu z následujících úloh:
   ...
   - Zadejte klíčové slovo, které chcete vyhledat v textovém poli. Například zadáním příkazu Update (aktualizovat) vyhledejte témata s klíčovými slovy, jako je například aktualizace, aktualizováno a aktualizace.
     ...
     > [!NOTE]
     > Když se tlačítko Filtr objeví na tmavším pozadí s ohraničením, musí položky obsahovat zadaný text. Pokud se pozadí a ohraničení nezobrazí, musí položky začínat textem, který zadáte.
