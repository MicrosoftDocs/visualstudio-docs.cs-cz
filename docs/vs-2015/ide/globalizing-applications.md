---
title: Globalizace aplikací | Microsoft Docs
ms.date: 11/15/2016
...
Globalizace je proces navrhování a vývoje softwarového produktu, který funguje pro více kultur. Tato část se vztahuje na stránky model Windows Forms a webových formulářů.

## <a name="in-this-section"></a>V tomto oddílu
 [Třídy pro globální model Windows Forms a webové formuláře specifické pro jazykovou verzi](../ide/culture-specific-classes-for-global-windows-forms-and-web-forms.md) Popisuje třídy, které formátuje data, čas, čísla, měnu a další informace podle nastavení jazykové verze.

## <a name="related-sections"></a>Související oddíly
 [Model Windows Forms globalizace](https://msdn.microsoft.com/library/72f6cd92-83be-45ec-aa37-9cb8e3ebc3c5) Obsahuje odkazy na stránky pro nápovědu týkající se globalizace model Windows Forms.
