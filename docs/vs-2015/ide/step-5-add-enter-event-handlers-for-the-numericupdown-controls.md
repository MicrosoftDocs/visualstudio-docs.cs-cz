...
3. Zadejte `5` a Všimněte si, že **350** se zobrazí, ale po druhém se změní na **100** .
     ...
     Než vyřešíte tento problém, zamyslete se nad tím, co se děje. Zvažte, proč **0** nezmizí při zadání `3` a proč se **350** změnil na **100** , ale ne hned.
...
2. Zvolte událost **ENTER** , zadejte `answer_Enter` a pak zvolte klávesu ENTER.
