...
Importuje, exportuje nebo resetuje nastavení [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)].
...
## <a name="switches"></a>Přepínače
 /export: `filename` nepovinný. Exportuje aktuální nastavení do zadaného souboru.
