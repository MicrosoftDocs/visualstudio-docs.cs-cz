---
title: Sada nástrojů | Microsoft Docs
ms.date: 11/15/2016
 ...
 **Sada nástrojů** zobrazuje pouze položky, které jsou vhodné pro typ souboru, ve kterém pracujete. Můžete hledat v rámci sady nástrojů a dále filtrovat položky, které se zobrazí. Pokud váš projekt vyžaduje ovládací prvek, který není podporován profilem klienta, můžete nastavit projekt tak, aby zacílen na celé rozhraní úpravou vlastností projektu.
