---
title: Možnosti, textový editor, Přípona souboru | Microsoft Docs
ms.date: 11/15/2016
 ...
 **Rozšíření** Zadejte příponu souboru s možností úprav v integrovaném vývojovém prostředí (IDE), které chcete definovat.

 **Editor** Vyberte Editor IDE nebo návrháře, ve kterém se otevřou dokumenty s touto příponou souboru. Když vyberete možnost s kódováním, zobrazí se dialogové okno pokaždé, když otevřete takový dokument, který umožňuje výběr schématu kódování.

 **Přidat** Přidá položku, která zahrnuje zadané **rozšíření** a **Možnosti úprav** v seznamu rozšíření.

 **Odebrat** Odstraní vybranou položku ze seznamu rozšíření.

 Seznam rozšíření obsahuje seznam všech rozšíření, pro které bylo zadáno prostředí pro úpravy.

 **Mapovat soubory s příponou na** Tuto možnost vyberte, pokud chcete určit, jak bude IDE zpracovávat soubory bez přípony.

 **Možnosti souboru s příponou** Poskytuje stejný seznam jako **Editor**. Vyberte Editor IDE nebo návrháře, ve kterém se otevřou dokumenty bez přípon souborů.
