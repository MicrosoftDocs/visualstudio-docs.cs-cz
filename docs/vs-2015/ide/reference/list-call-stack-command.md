...
## <a name="switches"></a>Přepínače
 ...
 /ShowExternalCode: `yes`&#124;`no` nepovinný. Určuje, zda se má pro zásobník volání zobrazit Pouze můj kód. Pokud je Pouze můj kód vypnutý, zobrazí se všechen neuživatelský kód. Když je Pouze můj kód zapnutý, zobrazí se neuživatelský kód jako `[external]` ve výstupu zásobník volání.

 Vlákno: `n` volitelné. Zobrazí zásobník volání pro vlákno `n` . Pokud není zadán žádný podproces, přehraje zásobník volání pro aktuální vlákno.
