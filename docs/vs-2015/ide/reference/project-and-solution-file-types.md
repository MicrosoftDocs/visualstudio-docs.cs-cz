...
[!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] podporuje mnoho typů souborů. V určité instalaci určují nainstalované součásti, které typy souborů jsou podporovány. Toto téma uvádí řešení a typy souborů projektu, které jsou podporovány v některých typických instalacích. Informace o dalších typech souborů najdete v části hledání pomocí přípon názvů souborů pro každý typ.
...
## <a name="project-files"></a>Soubory projektu
 [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] používá různé formáty souborů k ukládání informací specifických pro projekty. Další informace najdete v následujících tématech nápovědy:
