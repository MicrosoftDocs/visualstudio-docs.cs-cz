...
Toto dialogové okno umožňuje definovat [!INCLUDE[vcprvc](../../includes/vcprvc-md.md)] nastavení projektu souvisejícího s protokolováním sestavení a podpůrnými typy souborů.
 ...
 **Ano** Zapne generování souboru protokolu sestavení. Tato možnost generuje BuildLog. htm, kterou najdete v adresáři zprostředkujících souborů projektu. Každé nové sestavení přepíše předchozí soubor BuildLog. htm.
 ...
 **Ano** Zobrazí seznam proměnných prostředí v souboru protokolu sestavení. Tato možnost určuje, že se mají během sestavení [!INCLUDE[vcprvc](../../includes/vcprvc-md.md)] projektů do souboru protokolu sestavení zobrazovat všechny proměnné prostředí.
...
## <a name="see-also"></a>Viz také
 [Sestavení c/C++ programy](https://msdn.microsoft.com/library/fa6ed4ff-334a-4d99-b5e2-a1f83d2b3008) [c/C++ stavby – referenční](https://msdn.microsoft.com/library/100b4ccf-572c-4d1f-970c-fa0bc0cc0d2d) dokumentace
