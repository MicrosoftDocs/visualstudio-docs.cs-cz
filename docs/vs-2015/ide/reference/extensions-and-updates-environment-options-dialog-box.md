...
### <a name="automatically-check-for-updates"></a>Automaticky vyhledávat aktualizace
 V případě zaškrtnutí bude Visual Studio pravidelně kontrolovat aktualizace samotného, nainstalovaných sad SDK a nástrojů a rozšíření a zobrazovat oznámení v řádku nabídek, až budou aktualizace k dispozici. Další informace najdete v tématu [oznámení](../../ide/visual-studio-notifications.md).
...
### <a name="load-user-extensions-when-running-as-administrator"></a>Načíst rozšíření uživatelů při spuštění jako správce
