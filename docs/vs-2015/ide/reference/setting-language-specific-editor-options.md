...
## <a name="in-this-section"></a>V tomto oddílu
 ...
 [Ověřování, HTML, textový editor, dialogové okno Možnosti](https://msdn.microsoft.com/library/9c24ecfe-263e-4bf1-88de-d01be3992863) Popisuje nastavení pro kontrolu syntaxe jazyka HTML na základě zvoleného schématu.

 [Možnosti, textový editor, XAML, formátování](../../ide/reference/options-text-editor-xaml-formatting.md) Popisuje nastavení pro uspořádání elementů a atributů v dokumentech XAML.

## <a name="related-sections"></a>Související oddíly
 [Přizpůsobení editoru](../../ide/customizing-the-editor.md) Obsahuje odkazy na témata, která vysvětlují mnoho aspektů editoru, pro které můžete nastavit předvolby.

 [Přizpůsobení nastavení vývoje v aplikaci Visual Studio](https://msdn.microsoft.com/22c4debb-4e31-47a8-8f19-16f328d7dcd3) Obsahuje odkazy na témata, která vysvětlují, jak přizpůsobit nastavení, vazby klíčů a další funkce integrovaného vývojového prostředí (IDE).
