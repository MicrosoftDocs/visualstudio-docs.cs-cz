---
title: Tipy a triky pro usnadnění | Microsoft Docs
ms.date: 11/15/2016
...
[!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] obsahuje integrované funkce usnadnění, abyste mohli snadno pracovat z klávesnice a používat čtečky obrazovky nebo jiná zařízení s podporou technologie Assist. Téma obsahuje některé návrhy na optimalizaci [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] pro usnadnění a také některé užitečné kombinace klávesových zkratek.
...
|-----------------|---------------------|
|Zapnout a vypnout Vysoký kontrast|Levý **ALT + levý SHIFT + PRINT SCREEN**|
