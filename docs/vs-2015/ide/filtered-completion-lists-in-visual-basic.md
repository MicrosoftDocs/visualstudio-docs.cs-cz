---
title: Filtrované seznamy dokončení v Visual Basic | Microsoft Docs
ms.date: 11/15/2016
...
## <a name="see-also"></a>Viz také
 [Použití](../ide/using-intellisense.md) technologie IntelliSense [specifické pro Visual Basic](../ide/visual-basic-specific-intellisense.md) IntelliSense
