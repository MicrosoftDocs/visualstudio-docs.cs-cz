---
title: Navrhování tříd a typů (Návrhář tříd) | Microsoft Docs
ms.date: 11/15/2016
...
Pomocí **Návrhář tříd**nemůžete vizualizovat pouze třídy a typy, ale navrhovat je také. Následující témata popisují, jak to provést.

> [!NOTE]
> Při práci s Návrhář tříd byste měli zkontrolovat kód, který Emiter před spuštěním, aby ověřil, zda je kód vhodný pro váš kontext zabezpečení.

## <a name="in-this-section"></a>V tomto oddílu
 [Postupy: Vytváření typů pomocí Návrháře tříd](../ide/how-to-create-types-by-using-class-designer.md)

 Popisuje, jak použít diagram tříd pro vytvoření typu.
 ...
 Popisuje, jak definovat přidružení v diagramu tříd.
