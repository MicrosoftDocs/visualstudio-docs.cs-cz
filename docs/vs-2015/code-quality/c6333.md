...
Upozornění C6333: neplatný parametr: předávání MEM_RELEASE a nenulový parametr nenulového dwSize funkci pro \<function> není povolen. Výsledkem je selhání tohoto volání.  
