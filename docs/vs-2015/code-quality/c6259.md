...
## <a name="example"></a>Příklad  
 Následující vzorový kód vygeneruje toto upozornění, protože výraz `switch``(rand() & 3)` nelze vyhodnotit na návěští Case (`case` `4`):  
...
## <a name="see-also"></a>Viz také  
 [příkaz switch (C++)](https://msdn.microsoft.com/library/6c3f3ed3-5593-463c-8f4b-b33742b455c6)   
