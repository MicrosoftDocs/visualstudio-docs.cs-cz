...
Upozornění C6263: použití _alloca ve smyčce; To může rychle přetečení zásobníku  
 ...
 Vyhněte se volání `_alloca` uvnitř smyčky, pokud buď je velikost alokace, nebo počet iterací neznámý, protože by mohlo dojít k přetečení zásobníku. V těchto případech zvažte další možnosti, jako například, paměť haldy nebo [ C++ třídy standardní knihovny](https://msdn.microsoft.com/library/a37d3ba3-58af-47c7-9ee2-441ccd7b77ee) .  
