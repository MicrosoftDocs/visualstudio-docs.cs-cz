...
Upozornění C28215: typefix nelze použít na parametr, který již má typefix  
 ...
 Použití `__typefix` poznámky na parametr, který již tuto poznámku obsahuje, je chyba. `__typefix`Poznámky jsou používány pouze ve výjimečných případech a toto upozornění se neočekává při běžném použití.
