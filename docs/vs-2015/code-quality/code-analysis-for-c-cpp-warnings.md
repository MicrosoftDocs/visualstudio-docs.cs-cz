...
Tato část obsahuje seznam upozornění analýzy kódu v jazyce C/C++. Informace o analýze kódu naleznete v tématu [/analyze (Code Analysis)](https://msdn.microsoft.com/library/81da536a-e030-4bd4-be18-383927597d08) a [rychlé zprovoznění: Analýza kódu pro C/C++](../code-quality/quick-start-code-analysis-for-c-cpp.md).  
  
## <a name="see-also"></a>Viz také  
 [Pokyny pro psaní zabezpečeného kódu](https://msdn.microsoft.com/9892fd19-45cd-44b6-9fa8-10f1b5cb6ea4)   
 [Analýza kvality kóduC++ C/kódu pomocí  analýzy kódu](../code-quality/analyzing-c-cpp-code-quality-by-using-code-analysis.md)  
