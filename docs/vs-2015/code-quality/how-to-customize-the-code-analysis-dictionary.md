...
Analýza kódu používá integrovaný slovník ke kontrole identifikátorů ve vašem kódu pro chyby v pravopisu, gramatickém případu a dalších konvencích pojmenovávání [!INCLUDE[dnprdnshort](../includes/dnprdnshort-md.md)] pokynů. Soubor XML vlastního slovníku můžete vytvořit tak, že přidáte, odeberete nebo upravíte výrazy, zkratky a zkratky do integrovaného slovníku.
