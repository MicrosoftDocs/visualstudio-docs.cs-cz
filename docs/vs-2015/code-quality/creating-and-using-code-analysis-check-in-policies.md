...
Při použití Správa verzí Team Foundation (TFVC) můžete vytvořit zásadu pro vrácení se změnami analýzy kódu pro projekty .NET Framework a nativní (C/C++) kódu v týmovém projektu. Můžete použít zásadu vrácení se změnami analýzy kódu pro kontrolu a zlepšení kvality kódu, který je vrácen do základu kódu.
...
## <a name="in-this-section"></a>V tomto oddílu
 ...
 [Kompatibilita verzí pro zásady vracení se změnami analýzy kódu](../code-quality/version-compatibility-for-code-analysis-check-in-policies.md) Vysvětluje problémy s kompatibilitou při analýze kódu mezi verzemi [!INCLUDE[vstsLong](../includes/vstslong-md.md)] .
