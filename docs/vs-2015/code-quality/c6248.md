...
```  
 ...
 Úplný příklad vytvoření popisovače zabezpečení naleznete v tématu [Vytvoření popisovače zabezpečení pro nový objekt v C++ ](https://msdn.microsoft.com/library/aa446595.aspx). Další informace najdete v tématu [Vytvoření seznamu DACL](https://msdn.microsoft.com/library/ms717798.aspx).
