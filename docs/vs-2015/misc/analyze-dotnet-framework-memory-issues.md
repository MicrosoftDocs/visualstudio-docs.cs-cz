...
- **Velikost (bajty)** je velikost všech instancí typu s výjimkou velikosti objektů, na které jsou odkazy uloženy. Prostředek  
...
- **Velikost (bajty)** je velikost objektu s výjimkou velikosti objektů, na které obsahuje odkazy. Prostředek  
