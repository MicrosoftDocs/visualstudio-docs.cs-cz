---
title: Spustit zobrazení | Microsoft Docs
ms.date: 11/15/2016
...
Zobrazení Start je bod spuštění pro návrháře schématu XML (XSD). Při vytváření nového souboru XSD se zpočátku zobrazí úvodní zobrazení.
 ...
 ![Úvodní zobrazení návrháře schématu XML](../xml-tools/media/xsddesigner-startview.gif "XSDDesigner_StartView")
...
## <a name="toolbar"></a>Panel nástrojů
 ...
 ![Panel nástrojů Návrhář schématu XML](../xml-tools/media/xsdstartviewtoolbar.gif "XSDStartViewToolbar")
...
## <a name="see-also"></a>Viz také
 [XML – Průzkumník schémat](../xml-tools/xml-schema-explorer.md) [– zobrazení](../xml-tools/graph-view.md) [modelu obsahu](../xml-tools/content-model-view.md) zobrazení [editoru XML](../xml-tools/xml-editor.md)
