...
### <a name="c-trait-attribute-macros"></a>C++makra atributu vlastnosti

|Podokně|Popis|
|-----------|-----------------|
|`TEST_METHOD_ATTRIBUTE(attributeName, attributeValue)`|Použijte makro TEST_METHOD_ATTRIBUTE k definování vlastnosti.|
