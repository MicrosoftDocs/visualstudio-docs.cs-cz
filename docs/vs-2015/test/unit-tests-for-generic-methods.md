...
- [Úpravy generovaného testovacího kódu](#EditingGeneratedTestCode). Tento příklad obsahuje dva oddíly, generovaný testovací kód a upravený testovací kód. Ukazuje, jak upravit nezpracovaný testovací kód, který je vygenerován z obecné metody do užitečné testovací metody.
...
## <a name="see-also"></a>Viz také
 [Anatomie jednotky testu jednotek](https://msdn.microsoft.com/a03d1ee7-9999-4e7c-85df-7d9073976144) [testování kódu](../test/unit-test-your-code.md)
