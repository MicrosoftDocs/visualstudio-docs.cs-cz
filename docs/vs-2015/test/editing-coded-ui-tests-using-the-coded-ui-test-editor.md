...
## <a name="how-do-i-do-this"></a>Jak to mám udělat?
...
## <a name="CodedUITestEditor_EditActionAndControlProperties"></a>Úprava vlastností akce uživatelského rozhraní a jejich odpovídajících vlastností ovládacích prvků
 ...
 Po dokončení úprav uložte změny do souboru UIMap. Designer kliknutím na tlačítko **Uložit** na panelu nástrojů [!INCLUDE[vsprvs](../includes/vsprvs-md.md)].
...
- ![Tip](../test/media/tip.png "Tip") Může být nutné rozšířit ovládací prvek kontejneru, který obsahuje ovládací prvek, který chcete upravit. [!INCLUDE[crdefault](../includes/crdefault-md.md)][vyhledání ovládacího prvku a jeho následníků, které](#CodedUITestEditor_LocateDecendants) jsou uvedeny dále v tomto tématu.

## <a name="CodedUITestEditor_DeleteUIActions"></a>Odstranit nechtěné akce uživatelského rozhraní
...
## <a name="CodedUITestEditor_SplitMethods"></a>Rozdělení testovací metody do dvou samostatných metod
 ...
 Po dokončení rozdělení metody uložte změny do souboru UIMap. Designer kliknutím na tlačítko **Uložit** na panelu nástrojů [!INCLUDE[vsprvs](../includes/vsprvs-md.md)].
...
## <a name="CodedUITestEditor_MoveMethods"></a>Přesunutí testovací metody do souboru UIMap, aby se usnadnilo přizpůsobení
 ...
 Po dokončení přesunutí metody uložte změny do souboru UIMap. Designer kliknutím na **Uložit** na panelu nástrojů [!INCLUDE[vsprvs](../includes/vsprvs-md.md)].
...
## <a name="CodedUITestEditor_LocateUIControl"></a>Vyhledání ovládacího prvku uživatelského rozhraní v testované aplikaci
...
- ![](../test/media/caution.gif "Upozornění") **Upozornění** na ikonu upozornění: před UMÍSTĚNÍM ovládacího prvku uživatelského rozhraní ověřte, zda je aplikace přidružená k testu spuštěna.
...
## <a name="CodedUITestEditor_LocateDecendants"></a>Vyhledání ovládacího prvku a jeho následníků
...
- ![](../test/media/caution.gif "Upozornění") **Upozornění** na ikonu upozornění: před UMÍSTĚNÍM ovládacích prvků uživatelského rozhraní ověřte, zda je aplikace přidružená k testu spuštěna.

## <a name="CodedUITestEditor_InsertDelay"></a>Vložení zpoždění před akci uživatelského rozhraní
