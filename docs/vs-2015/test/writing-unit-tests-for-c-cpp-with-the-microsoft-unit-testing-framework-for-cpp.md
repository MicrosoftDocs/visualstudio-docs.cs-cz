---
title: Zápis testů částí pro C –C++ s architekturou testování částí společnosti Microsoft C++ pro | Microsoft Docs
ms.date: 11/15/2016
...
V aplikaci Visual Studio můžete vytvořit testy jednotek pro nespravovaný kód napsaný C++v. Nespravovaný kód se někdy označuje jako nativní kód.
...
2. Zpřístupněte knihovnu DLL pro projekt testů:
    ...
    - `#include` `.h` soubor, který obsahuje deklarace externě přístupných funkcí DLL.

         Soubor `.h` by měl obsahovat deklarace funkcí označené `_declspec(dllimport)`. Alternativně můžete metody exportovat pomocí DEF souboru. Další informace najdete v tématu [Import a export](https://msdn.microsoft.com/library/7c44c2aa-2117-4cec-9615-a65bfd3f8f7b).
...
3. V testovacím projektu vytvořte testovací třídy a testovací metody pomocí těchto TESTOVACÍch maker a třídy Assert následujícím způsobem:
    ...
    - Parametr `LINE_INFO()` je nepovinný. V případech, kdy není k dispozici žádný soubor PDB, umožňuje nástroji Test Runner identifikovat umístění selhání.

    - Můžete také napsat nastavení testu a metody vyčištění. Chcete-li získat další informace, otevřete definici makra `TEST_METHOD` a přečtěte si komentáře v CppUnitTest. h.
...
## <a name="walkthrough"></a>Návod: Vývoj nespravované knihovny DLL pomocí Průzkumníka testů
...
### <a name="unitTestProject"></a>Vytvořit nativní projekt testu jednotek

1. V nabídce **soubor** klikněte na příkaz **Nový**, **projekt**.

     V dialogovém okně rozbalte položku **nainstalováno**, **šablony**, **vizuál C++** , **test**.

     Vyberte šablonu **projektu nativního testu** .

     V tomto návodu se projekt testů jmenuje `NativeRooterTest`.

     ![Vytvoření projektu testů&#43; &#43; jednotek v jazyce C](../test/media/utecpp01.png "UteCpp01")

2. V novém projektu zkontrolujte **UnitTest1. cpp.**

     ![Testovací projekt s testovací&#95;třídou a&#95;testovací metodou](../test/media/utecpp2.png "UteCpp2")
...
### <a name="createDllProject"></a>Vytvořit projekt nespravované knihovny DLL

1. Vytvořte  **C++ vizuální** projekt pomocí šablony **projektu Win32** .

     V tomto návodu se projekt jmenuje `RootFinder`.

     ![Vytvoření projektu Win32&#43; &#43; v jazyce C](../test/media/utecpp05.png "UteCpp05")
...
2. V Průvodci aplikací Win32 vyberte **DLL** a **exportujte symboly** .
     ...
     ![Průvodce&#43; &#43; projektem jazyka C pro knihovnu DLL a export symbolů](../test/media/utecpp06.png "UteCpp06")
...
3. Deklarujte exportovanou funkci v souboru Principal. h:
     ...
     Deklarátor `__declspec(dllexport)` způsobí, že veřejné a chráněné členy třídy budou viditelné vně knihovny DLL. Další informace naleznete v tématu [použití dllimport a dllexport ve C++ třídách](https://msdn.microsoft.com/library/8d7d1303-b9e9-47ca-96cc-67bf444a08a9).
...
### <a name="coupleProjects"></a>Spojit projekt testů s projektem knihovny DLL
...
1. Přidejte projekt knihovny DLL do odkazů projektu testovacího projektu:
   ...
   1. Otevřete vlastnosti testovacího projektu a vyberte možnost **společné vlastnosti**, **rozhraní a odkazy**.
        ...
        ![C++&#43; &#43; – rozhraní &#45; a odkazy na vlastnosti projektu](../test/media/utecpp08.png "UteCpp08")
...
5. V Průzkumníku testů vyberte možnost **Spustit vše**.
    ...
    ![Test jednotek – &#45; základní test Průzkumníka testů byl úspěšný](../test/media/utecpp10.png "UteCpp10")
...
4. Sestavte řešení a potom v Průzkumníku testů zvolte možnost **Spustit vše**.
     ...
     ![Test rozsahu Průzkumníka &#45; testů jednotek byl úspěšný](../test/media/utecpp12.png "UteCpp12")
...
## <a name="see-also"></a>Viz také
 [Přidání jednotkových testů do C++ existujících aplikací](../test/unit-testing-existing-cpp-applications-with-test-explorer.md) [pomocí Microsoft. VisualStudio. TestTools. CppUnitTestFramework](../test/using-microsoft-visualstudio-testtools-cppunittestframework.md) [Přehled přehledu o spolupráci spravovaného/nespravovaného kódu](https://msdn.microsoft.com/library/ms973872.aspx) v článku [ladění nativního kódu](../debugger/debugging-native-code.md) [: Vytvoření a použití dynamické knihovny (C++) pro](https://msdn.microsoft.com/library/3ae94848-44e7-4955-bbad-7d40f493e941) [Import a export](https://msdn.microsoft.com/library/7c44c2aa-2117-4cec-9615-a65bfd3f8f7b)
