...
### <a name="starting-and-stopping-the-application-under-test"></a><a name="starting"></a> Spuštění a zastavení testované aplikace
...
### <a name="validating-the-properties-of-ui-controls"></a><a name="VerifyingCodeUsingCUITGenerateAssertions"></a> Ověřování vlastností ovládacích prvků uživatelského rozhraní
...
- Přidá metodu volanou `AssertForAddTwoNumbers` do vaší mapy uživatelského rozhraní (UIMap. UITest). Tento soubor se otevře v editoru programového testu UI, kde můžete upravit kontrolní výrazy.
  ...
  *Ovládací prvek, který chcete vybrat, ztratí fokus a zmizí při pokusu o výběr nástroje Přidat kontrolní výrazy z Tvůrce programového testu uživatelského rozhraní. Návody vybrat ovládací prvek?* 
   **Výběr skrytého ovládacího prvku pomocí klávesnice**
 ...
 **Ruční zaznamenávání ukazatele myši**
 ...
 ![CodedUI&#95;najetí myší](../test/media/codedui-hover.png "CodedUI_Hover")
 ...
 **Nastavení implicitního efektu myši pro webový prohlížeč**
 ...
 Ověřte, že konfigurační soubor má klíč `RecordImplicitiHovers` nastavený na hodnotu, jak je `true` znázorněno v následující ukázce:
...
## <a name="customizing-your-coded-ui-test"></a><a name="VerifyingCodeCUITModify"></a> Přizpůsobení kódovaného testu uživatelského rozhraní
...
### <a name="the-generated-code"></a><a name="generatedCode"></a> Generovaný kód
...
### <a name="coding-ui-control-actions-and-properties"></a><a name="actions"></a> Kódování akcí a vlastností ovládacích prvků uživatelského rozhraní
