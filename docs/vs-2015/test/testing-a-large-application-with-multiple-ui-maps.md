...
4. Klikněte na tlačítko **Přidat**.
    ...
    [!INCLUDE[vsprvs](../includes/vsprvs-md.md)]Okno se minimalizuje a zobrazí se dialogové okno Tvůrce programového **testu uživatelského rozhraní** .
...
## <a name="example"></a>Příklad
 ...
 V tomto příkladu má webová aplikace s názvem stránku `Contoso` domů, stránku produktu a nákupní košík. Každá z těchto stránek sdílí společné okno nejvyšší úrovně, které je oknem prohlížeče. K dispozici je mapa uživatelského rozhraní pro každou stránku a třída utility má kód podobný následujícímu:
