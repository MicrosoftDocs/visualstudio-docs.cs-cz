...
> [!NOTE]
> Další informace o Managed Extensibility Framework naleznete v tématu [Managed Extensibility Framework (MEF)](https://msdn.microsoft.com/library/6c61b4ec-c6df-4651-80f1-4854f8b14dde).  
...
```  
 ...
 [Návod: zobrazení inteligentních inteligentních zobrazení](../misc/walkthrough-displaying-smarttags.md)  
