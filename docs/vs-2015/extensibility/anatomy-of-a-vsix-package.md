...
> [!NOTE]
> Názvy souborů obsažených v balíčcích VSIX nesmí obsahovat mezery, ani znaky, které jsou vyhrazeny v identifikátorech URI (Uniform Resource Identifier), jak je definováno v [ \[ RFC2396 \] ](https://go.microsoft.com/fwlink/?LinkId=90339).  
...
## <a name="dependencies-and-references"></a>Závislosti a odkazy  
 ...
 Pokud projekt v řešení více projektů obsahuje odkaz na jiný projekt ve stejném řešení, balíček VSIX obsahuje závislosti daného projektu. Toto chování můžete přepsat kliknutím na odkaz na interní projekt a poté v okně **vlastnosti** nastavením **výstupních skupin zahrnutých do vlastnosti VSIX** na `BuiltProjectOutputGroup` .  
...
## <a name="installation-location"></a>Umístění instalace  
 ...
 Ve výchozím nastavení se instalace vztahuje pouze na aktuálního uživatele, protože% LocalAppData% je adresářem specifickým pro uživatele. Nicméně pokud nastavíte element [AllUsers](https://msdn.microsoft.com/ac817f50-3276-4ddb-b467-8bbb1432455b) manifestu na `True` , bude rozšíření nainstalováno v.. \\ *VisualStudioInstallationFolder*\Common7\IDE\Extensions a budou k dispozici pro všechny uživatele počítače.  
...
## <a name="content_typesxml"></a>[Content_Types]. XML  
 ...
 Soubor [Content_Types]. XML je vyžadován standardem OPC (Open balící konvence). Další informace o OPC naleznete v tématu [OPC: nový standard pro balení dat](https://msdn.microsoft.com/magazine/cc163372.aspx) na webu MSDN.
