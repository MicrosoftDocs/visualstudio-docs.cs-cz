...
Vývojáři podnikových aplikací, kteří používají váš balíček sady VS, mohou pohodlně seskupit podobné typy projektů společně v [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] pomocí *vnoření projektu*. Například projekt šablony organizace používá vnořené projekty k seskupení projektů do kategorií. Projekty obchodní fasády, projekty webového uživatelského rozhraní a tak dále jsou seskupeny do jedné kategorie.  
...
## <a name="nested-projects-example"></a>Příklad vnořených projektů  
 (../../extensibility/internals/media/vsnestedprojects.gif "VsNestedProjects") ![řešení pro vnořené projekty]  
