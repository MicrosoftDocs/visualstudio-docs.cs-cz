...
ms.locfileid: "64837594"
---
# <a name="registering-a-project-type"></a>Registrace typu projektu
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Při vytváření nového typu projektu je nutné vytvořit položky registru, které umožňují [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] rozpoznat a pracovat s typem projektu. Tyto položky registru obvykle vytváříte pomocí souboru skriptu registru (. rgs).  
