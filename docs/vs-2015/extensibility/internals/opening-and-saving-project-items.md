...
Když přidáte nový typ projektu, musíte spravovat otevírání a ukládání souborů projektů v [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] integrovaném vývojovém prostředí (IDE). Následující témata popisují různé přístupy k otevírání a ukládání souborů.  
