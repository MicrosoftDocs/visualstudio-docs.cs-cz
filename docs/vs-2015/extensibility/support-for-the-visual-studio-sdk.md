...
### <a name="visual-studio-product-support"></a>Podpora produktu Visual Studio  
 Součástí nákupu [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] produktů je i podpora. Další informace najdete v tématu [Podpora sady Visual Studio](https://msdn.microsoft.com/vstudio/cc136615.aspx). Společnost Microsoft udržuje vyhrazený tým podpory pro zodpovězení otázek o rozšíření [!INCLUDE[vsprvs](../includes/vsprvs-md.md)].  
...
### <a name="developer-tools-support"></a>Podpora Vývojářské nástroje  
 ...
 Zákazníci, kteří chtějí použít [!INCLUDE[vsipsdk](../includes/vsipsdk-md.md)] k vývoji složitých balíčků, mohou zvážit nákup Premier Support smlouvy s Microsoftem. Další informace najdete v tématu [Microsoft Premier Support](https://support.microsoft.com/premier). Pro malé společnosti může být [Rozšířená podpora pro partnery](https://partner.microsoft.com/support/advanced-cloud-support) zajímavou alternativou tradiční nabídky Premier Support.  
