...
|Vytváření a zničení událostí|Odesílá se k oznámení vytvoření nebo zničení procesů, programů, vlastností, relací a vláken, takže integrované vývojové prostředí (IDE) sady Visual Studio může sledovat stav laděných programů.|  
