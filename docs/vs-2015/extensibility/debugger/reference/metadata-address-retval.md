...
## <a name="terms"></a>Terminologie  
 ...
 dwCorType  
 Základní typ návratové hodnoty. Toto je hodnota z `CorElementType` výčtu definovaného v [!INCLUDE[dnprdnshort](../../../includes/dnprdnshort-md.md)] souboru corhdr. h sady SDK.  
