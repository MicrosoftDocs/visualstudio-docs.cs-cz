...
Tento oddíl obsahuje informace o elementech XML v souborech .vstemplate, což jsou soubory, do nichž se ukládají metadata pro šablony projektů, šablony položek a úvodní sady.  
 ...
 Vlastní soubory .vstemplate můžete ověřit pomocí souboru vstemplate.xsd. Tento soubor je k dispozici na adrese... \\ *Instalační složka sady Visual Studio*\Xml\Schemas\1033\vstemplate.xsd.  
...
|[Odkazy](../extensibility/references-element-visual-studio-templates.md)|Reference|--|  
