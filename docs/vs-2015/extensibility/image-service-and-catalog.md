...
## <a name="how-do-i-use-image-monikers-in-a-new-tool-window"></a>Návody použít monikery obrázků v novém okně nástroje?  
 Šablona projektu balíčku VSIX byla aktualizována pro sadu Visual Studio 2015. Chcete-li vytvořit nové okno nástroje, klikněte pravým tlačítkem na projekt VSIX a vyberte možnost Přidat novou položku... (Ctrl + Shift + A). V uzlu rozšiřitelnost pro jazyk projektu vyberte vlastní okno nástrojů, zadejte název okna nástroje a stiskněte tlačítko Přidat.  

 Jedná se o klíčová místa pro použití monikerů v okně nástroje. Postupujte podle pokynů pro každý z těchto kroků:  

1. Karta okna nástroje, když se karty dostatečně zmenší (použijí se taky v přepínači okna CTRL + TAB).  
...
3. Karta okna nástroje, když se karty dostatečně zmenší (použijí se taky v přepínači okna CTRL + TAB).  
   ...
   2. Viz krok #1 v tématu jak použít monikery obrázků v novém okně nástrojů? " výše v části.  

4. Příkaz pro otevření okna nástroje.  

   - Viz krok #2 v tématu jak použít monikery obrázků v novém okně nástrojů? " výše v části.  
