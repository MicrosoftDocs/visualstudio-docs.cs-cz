...
#### <a name="parameters"></a>Parametry  
 ...
 lpComment  
 pro Komentář, který se má použít u všech vybraných souborů, které se vrátí se změnami Toto je v `NULL` případě, že se v modulu plug-in správy zdrojových kódů zobrazuje výzva k zadání komentáře.  
