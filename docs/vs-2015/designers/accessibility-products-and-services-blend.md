...
### <a name="free-step-by-step-tutorials"></a>Kurzy s podrobnými pokyny pro uživatele
 ...
 Podrobné kurzy pro produkty Microsoftu najdete na [webu Microsoft Accessibility (usnadnění](https://www.microsoft.com/enable)).

### <a name="assistive-technology-products-for-windows"></a>Technické pomůcky pro usnadnění pro systém Windows
 Existuje velké množství produktů s podpůrnou technologií, které postiženým osobám umožňují zjednodušit používání počítače. Katalog produktů s technologií usnadnění, které běží v systému Windows, můžete vyhledat na [webu Microsoft Accessibility (usnadnění](https://www.microsoft.com/enable)).
 ...
 **Sdružení Learning Ally**
 ...
 [Web Learning Ally](https://www.learningally.org/)
...
## <a name="for-more-information"></a>Další informace
 Další informace o tom, jak přístupné technologie pro počítače pomáhají zlepšit život osob s postižením, najdete na [webu Microsoft Accessibility (usnadnění](https://www.microsoft.com/enable)).
