---
title: Začínáme pomocí WPF | Microsoft Docs
ms.date: 11/15/2016
...
## <a name="see-also"></a>Viz také
 [Přehled vývoje aplikací](https://msdn.microsoft.com/library/bb613549\(v=vs.100\).aspx) [knihovny tříd (WPF)](https://msdn.microsoft.com/library/ms753307\(v=vs.100\).aspx) [.NET Framework centru pro vývojáře](https://dotnet.microsoft.com/) [vytváření moderních aplikací klasické pracovní plochy s Windows Presentation Foundation](../designers/create-modern-desktop-applications-with-windows-presentation-foundation.md)
