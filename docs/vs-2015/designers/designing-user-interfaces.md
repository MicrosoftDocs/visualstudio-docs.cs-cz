---
title: Navrhování uživatelských rozhraní | Microsoft Docs
ms.date: 11/15/2016
...
|K dispozici jsou standardní ikony pro vaše programy.|[Knihovna obrázků sady Visual Studio](../designers/the-visual-studio-image-library.md)|

## <a name="see-also"></a>Viz také
 [Návod: Vytvoření jednoduché aplikace](../ide/walkthrough-create-a-simple-application-with-visual-csharp-or-visual-basic.md) [v knihovně imagí sady Visual Studio](../designers/the-visual-studio-image-library.md)
