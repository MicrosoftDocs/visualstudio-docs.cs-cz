...
- Vytvoření a konfigurace datové sady pomocí [Průvodce konfigurací zdroje dat](https://msdn.microsoft.com/library/c4df7de5-5da0-4064-940c-761dd6d9e28f).
...
#### <a name="to-create-a-second-form-to-pass-the-data-to"></a>Vytvoření druhého formuláře pro předání dat
...
## <a name="add-a-tableadapter-query-to-form2-to-load-orders-for-the-selected-customer-on-form1"></a>Přidání dotazu TableAdapter do Form2 k načtení objednávek pro vybraného zákazníka na formuláři Form1

#### <a name="to-create-a-tableadapter-query"></a>Vytvoření dotazu TableAdapter
...
#### <a name="to-create-a-method-to-pass-data-to"></a>Vytvoření metody pro předání dat
...
#### <a name="to-create-a-method-to-pass-data-to-form2"></a>Vytvoření metody pro předání dat do Form2
