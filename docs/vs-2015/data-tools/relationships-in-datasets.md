...
|<xref:System.Data.Rule>|Cizí klíč v souvisejících podřízených záznamech je nastaven na výchozí hodnotu (jak je stanoveno vlastností <xref:System.Data.DataColumn.DefaultValue%2A> sloupce).|
