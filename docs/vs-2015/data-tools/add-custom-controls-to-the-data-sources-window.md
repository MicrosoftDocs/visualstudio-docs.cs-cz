...
## <a name="customizinglist"></a>Přizpůsobení seznamu ovládacích prvků s možností vazby pro datový typ
...
## <a name="addingcontrols"></a>Addcontrols se na seznam přidružených ovládacích prvků pro datový typ.
