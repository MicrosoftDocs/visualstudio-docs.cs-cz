...
||||
|-|-|-|
|SQL Server 2005 – 2016, včetně expresních a LocalDB|Firebird|MariaDB|
...
### <a name="net-languages"></a>Jazyky .NET
 ...
 Dokumentaci k přístupu k datům konkrétně související s ASP.NET najdete v tématu [práce s daty](http://www.asp.net/web-forms/overview/presenting-and-managing-data) na webu ASP.NET. Kurz použití Entity Framework s ASP.NET MVC najdete v článku [Začínáme s Entity Framework 6 Code First pomocí MVC 5](http://www.asp.net/mvc/overview/getting-started/getting-started-with-ef-using-mvc/creating-an-entity-framework-data-model-for-an-asp-net-mvc-application).
...
### <a name="native-c"></a>NativníC++
 ...
 C++programy, které pracují se Microsoft Azure Storage můžou používat [klienta Microsoft Azure Storage](http://www.nuget.org/packages/wastorage).

#### <a name="data-modeling"></a>Modelování dat
 Visual Studio neposkytuje vrstvu ORM pro C++.  [ODB](http://www.codesynthesis.com/products/odb/) je oblíbený Open Source ORM pro C++.
