...
## <a name="example"></a>Příklad  
 ...
 Po provedení úkolu `MySourceItemsWithMetadata` kolekce položek obsahuje položky `file1.resx` a `file2.resx` , obojí s položkami metadat pro `MyMetadata` . `MySourceItems`Kolekce položek se nezměnila.  
