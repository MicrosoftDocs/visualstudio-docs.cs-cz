...
|**SouborKnihovnyTypů**|Volitelný **řetězcový** parametr.<br /><br /> Určuje název souboru knihovny typů (. tlb). Pokud zadáte tento parametr, zadejte také parametr úlohy **ComponentFileNameMT** .<br /><br /> Další informace najdete na webu [MSDN](https://go.microsoft.com/fwlink/?LinkId=737) v možnosti **/TLB** na Mt. exe.|  
