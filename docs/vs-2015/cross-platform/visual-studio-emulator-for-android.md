...
## <a name="installing-and-uninstalling"></a><a name="Installing"></a> Instalace a odinstalace  
 Instalace  
...
## <a name="system-requirements-and-backward-compatibility"></a><a name="Requirements"></a> Požadavky na systém a zpětná kompatibilita  
...
## <a name="networking-in-the-visual-studio-emulator-for-android"></a><a name="Networking"></a> Sítě v emulátoru sady Visual Studio pro Android  
...
## <a name="configure-the-visual-studio-emulator-for-android"></a><a name="Configuring"></a> Konfigurace emulátoru sady Visual Studio pro Android  
...
## <a name="features-that-you-can-test-in-the-emulator"></a><a name="FeaturesTest"></a> Funkce, které můžete testovat v emulátoru  
...
## <a name="features-that-you-cant-test-in-the-emulator"></a><a name="FeaturesNonTest"></a> Funkce, které nemůžete testovat v emulátoru  
