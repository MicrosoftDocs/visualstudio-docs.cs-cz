...
Pokud potřebujete prozkoumat problémy s výkonem ve vaší aplikaci, je dobrým místem, kde začít, je porozumění tomu, jak využívá procesor. Nástroj **využití CPU** vám ukáže, kde CPU stráví čas, který provádí Visual C++, Visual C# webový Basic a JavaScript Code.  
