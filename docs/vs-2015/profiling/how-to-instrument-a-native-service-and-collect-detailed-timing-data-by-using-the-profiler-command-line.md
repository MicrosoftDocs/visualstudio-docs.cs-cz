...
Toto téma popisuje, jak používat [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] Nástroje pro profilaci nástroje příkazového řádku k instrumentaci nativní služby (C/C++) a shromažďování podrobných dat časování.  
