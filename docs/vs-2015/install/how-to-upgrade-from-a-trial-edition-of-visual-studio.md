...
3. Klikněte na odkaz **změnit licenci na produkt** .

4. Zadejte platný kód Product Key a pak klikněte na tlačítko **použít** .
...
## <a name="see-also"></a>Viz také
 [Jak nainstalovat Visual Studio](../install/install-visual-studio-2015.md) – [přihlášení k Visual Studiu](../ide/signing-in-to-visual-studio.md) [: vyhledání kódu Product Key pro Visual Studio](../install/how-to-locate-the-visual-studio-product-key.md) [vyhledání nebo změna kódu Product Key pro Team Foundation Server](https://msdn.microsoft.com/library/64f29927-b520-4c9f-b633-bcb527e562cd) [přizpůsobení nastavení vývoje v aplikaci Visual Studio](https://msdn.microsoft.com/22c4debb-4e31-47a8-8f19-16f328d7dcd3)