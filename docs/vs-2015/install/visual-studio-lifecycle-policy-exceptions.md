...
|[ASP.NET Web Stack](https://support.microsoft.com/kb/2902020)|ASP.NET MVC 4<br /><br /> ASP.NET MVC 5<br /><br /> Rozhraní API pro ASP.NET Web<br /><br /> Rozhraní API pro ASP.NET Web 2<br /><br /> ASP.NET – webové stránky 2<br /><br /> ASP.NET – webové stránky 3|  
...
|Aktualizace těchto komponent se distribuují prostřednictvím rozšíření NuGet a jejich životní cyklus se neřídí standardními zásadami společnosti Microsoft.  Další informace najdete v tématu [http://docs.nuget.org/](/nuget/) .|Obslužná rutina JSON Web Token pro Microsoft .NET Framework 4,5<br /><br /> NuGet 2.7<br /><br /> SignalR<br /><br /> Web Optimization Framework<br /><br /> WebGrease|  
