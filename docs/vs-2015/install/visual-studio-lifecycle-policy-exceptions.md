...
|[ASP.NET Web Stack](https://go.microsoft.com/fwlink/?LinkId=328918)|ASP.NET MVC 4<br /><br /> ASP.NET MVC 5<br /><br /> Rozhraní API pro ASP.NET Web<br /><br /> Rozhraní API pro ASP.NET Web 2<br /><br /> ASP.NET – webové stránky 2<br /><br /> ASP.NET – webové stránky 3|  
