...
|Aktualizace těchto komponent se distribuují prostřednictvím rozšíření NuGet a jejich životní cyklus se neřídí standardními zásadami společnosti Microsoft.  Další informace najdete tady: [http://docs.nuget.org/](/nuget/).|Obslužná rutina JSON Web Token pro Microsoft .NET Framework 4,5<br /><br /> NuGet 2.7<br /><br /> SignalR<br /><br /> Web Optimization Framework<br /><br /> WebGrease|  
