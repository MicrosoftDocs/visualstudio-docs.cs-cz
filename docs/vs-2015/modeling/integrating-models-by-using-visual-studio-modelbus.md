...
## <a name="provide"></a>Poskytnutí přístupu k DSL
 Než budete moci vytvořit ModelBus odkazy na model nebo jeho prvky, je nutné definovat ModelBusAdapter pro DSL. Nejjednodušší způsob, jak to provést, je použít rozšíření [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] model bus, které přidá příkazy do návrháře DSL.
