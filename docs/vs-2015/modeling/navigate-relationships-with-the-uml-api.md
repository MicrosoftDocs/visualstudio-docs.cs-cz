...
## <a name="enumerating-relationships"></a>Vytváření výčtu relací
 Všechny vlastnosti modelu UML, který vrací více hodnot, odpovídají rozhraní IEnumerable < >. To znamená, že můžete použít [výrazy dotazů LINQ](https://docs.microsoft.com/dotnet/csharp/linq/index) a metody rozšíření definované v oboru názvů **System. Linq** .
