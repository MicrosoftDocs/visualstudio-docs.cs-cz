...
Transakce zajistí, že se změny provedené v úložišti považují za skupinu. Změny, které jsou seskupeny, lze potvrdit nebo vrátit zpět jako jednu jednotku.
 ...
 Kdykoli se kód programu změní, přidá nebo odstraní libovolný prvek v úložišti v sadě [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] vizualizace a sada SDK pro modelování, musí tak učinit uvnitř transakce. Pokud dojde ke změně, musí být k úložišti přidružena aktivní instance <xref:Microsoft.VisualStudio.Modeling.Transaction>. To platí pro všechny prvky modelu, vztahy, obrazce, diagramy a jejich vlastnosti.
