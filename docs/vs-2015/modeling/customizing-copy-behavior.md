...
V rámci jazyka DSL (Domain-Specific Language) vytvořeného pomocí [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] vizualizace a modelování sady SDK můžete změnit, co se stane, když uživatel zkopíruje a vloží prvky.
