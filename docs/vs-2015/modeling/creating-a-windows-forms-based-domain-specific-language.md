...
Model Windows Forms můžete použít k zobrazení stavu modelu DSL (Domain-Specific Language) namísto použití diagramu DSL. Toto téma vás provede vazbou formuláře Windows na DSL pomocí [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] vizualizace a sady Modeling SDK.
...
2. Experimentujte s úvodním příkladem, který šablona poskytuje:
   ...
   V hlavní instanci nástroje [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] si všimněte následujících bodů řešení DSL:
