...
Rozhraní neměnnosti API sady pro [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] vizualizaci a modelování umožňuje programu uzamknout část nebo celý model DSL (Domain-Specific Language), aby jej bylo možné číst, ale nikoli měnit. Tuto možnost lze použít například k tomu, aby uživatel mohl požádat o přístup k modelu DSL a zkontrolovat ho, aby se v něm změnil originál.
...
> Zásady zamykání lze obejít pomocí reflexe. Poskytuje jasné hranice pro vývojáře třetích stran, ale neposkytuje silné zabezpečení.
 ...
 Další informace jsou k dispozici na webu [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] [sady SDK pro vizualizaci a modelování](https://www.microsoft.com/download/details.aspx?id=48148) .
