---
title: Typy prvků modelu UML | Microsoft Docs
ms.date: 11/15/2016
...
Model UML můžete číst a manipulovat pomocí programovacího rozhraní. Toto téma shrnuje hierarchii typů prvků. Hierarchie je stejná jako ta, která je definovaná ve specifikaci UML.
...
## <a name="see-also"></a>Viz také
 [Definování profilu pro rozšíření](../modeling/define-a-profile-to-extend-uml.md) [omezení ověření definice UML pro](../modeling/define-validation-constraints-for-uml-models.md) [referenční informace k rozhraní API modelů UML pro rozšíření modelování UML](../modeling/api-reference-for-uml-modeling-extensibility.md)
