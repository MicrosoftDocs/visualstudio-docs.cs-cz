---
title: 'Postupy: Přidání obslužné rutiny přetažení myší | Microsoft Docs'
ms.date: 11/15/2016
...
- [Jak dekódovat přetaženou položku](#extracting). Prvky lze přetáhnout z libovolného okna nebo z plochy i z DSL.

- [Jak získat původní přetaženou položku](#getOriginal). Pokud je přetažená položka prvkem DSL, můžete otevřít zdrojový model a přistupovat k elementu.
...
## <a name="see-also"></a>Viz také
 [Přizpůsobení chování kopírování](../modeling/customizing-copy-behavior.md) [nasazení řešení jazyka specifického pro doménu](../modeling/deploying-domain-specific-language-solutions.md)
