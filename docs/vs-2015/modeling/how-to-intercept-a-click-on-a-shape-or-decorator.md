---
title: 'Postupy: zachycení kliknutí na obrazec nebo dekoratér | Microsoft Docs'
ms.date: 11/15/2016
...
4. Přepište metodu InitializeShapeFields ve třídách tvarů přidáním následující definice částečné třídy.
...
## <a name="see-also"></a>Viz také
 [Reagování na změny](../modeling/responding-to-and-propagating-changes.md) [vlastností dekoratéry a jejich](../modeling/properties-of-decorators.md) šíření
