---
title: Přizpůsobení prezentace v diagramu | Microsoft Docs
ms.date: 11/15/2016
...
ms.locfileid: "72655005"
---
# <a name="customizing-presentation-on-the-diagram"></a>Přizpůsobení prezentace v diagramu
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Diagram je hlavní prezentační oblast návrháře jazyka specifického pro doménu. Obvykle uživatelé použijí diagram k vytvoření svých modelů. Diagram můžete přizpůsobit, jak je popsáno v následujících tématech.
