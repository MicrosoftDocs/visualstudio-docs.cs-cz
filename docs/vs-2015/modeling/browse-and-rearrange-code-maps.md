...
- Podívejte se na clustery s přirozenými závislostmi v kódu. Na panelu nástrojů Mapa klikněte na **Layout**tlačítko rozložení **, rychlé clustery**![rychlé clustery na panelu nástrojů grafu](../modeling/media/quickclustersicon.gif "QuickClustersIcon"). Viz [Změna rozložení mapy](#Selecting).

     ![Graf závislosti &#45; rozložení pro rychlé clustery](../modeling/media/dependencygraph-quickclusters.png "DependencyGraph_QuickClusters")
...
|------------|-----------------------------|
|Uspořádat tok závislostí pro celou mapu v určitém směru. To vám může pomáhat při zobrazení vrstev architektury v kódu.|Na panelu nástrojů mapa zvolte **rozložení**a pak:<br /><br /> -   Tlačítko **shora** dolů shora dolů v ![grafu](../modeling/media/topbottomgraphbutton.gif "TopBottomGraphButton")<br />-   Tlačítko **zdola** shora ![dolů na horní graf](../modeling/media/bottomtopgraphbutton.gif "BottomTopGraphButton")<br />-   **Zleva doprava** ![doleva k pravému rozložení tlačítka](../modeling/media/leftrightgraphbutton.gif "LeftRightGraphButton")<br />-   Tlačítko **zprava doleva** ![vpravo k levému grafu](../modeling/media/rightleftgraphbutton.gif "RightLeftGraphButton")|
...
|Změna rozložení v rámci skupiny nezávisle na ostatních uzlech a skupinách na mapě.|Vyberte uzel a otevřete místní nabídku. Zvolte **rozložení** a vyberte styl rozložení.<br /><br /> - nebo -<br /><br /> Vyberte uzel a rozbalte ho pro zobrazení podřízených uzlů. Kliknutím na název uzlu zobrazíte místní panel nástrojů pro skupinu a otevřete okno **změnit styl rozložení**![grafu závislostí skupiny &#45; panelu nástrojů skupiny &#45; seznamu rozložení](../modeling/media/dependencygraph-grouptoolbar.gif "DependencyGraph_GroupToolbar") . Vyberte jedno z rozložení stromové struktury, **rychlé clustery**nebo **zobrazení seznamu** (které uspořádá obsah skupiny do seznamu).<br /><br /> Další podrobnosti najdete v tématu [skupiny uzlů](#OrganizeGroups) .|
...
|**Záměr**|**Proveďte tyto kroky**|
|------------|-----------------------------|
|Naskenujte mapu.|Přetáhněte mapu v libovolném směru pomocí myši.<br /><br /> - nebo -<br /><br /> Podržením **klávesy SHIFT** a otočením kolečka myši se posuňte vodorovně. Podržte stisknutou klávesu **SHIFT**  +  **CTRL** a otáčejte kolečkem myši, aby se posouvají vodorovně.|
...
|**Záměr**|**Na panelu nástrojů mapa zvolte rozložení, Upřesnit a pak zvolte**|
|------------|----------------------------------------------------------------------|
...
6. Otevřete místní nabídku prvku kódu a vyberte možnost **Upravit**, **Přidat**, **obecný odkaz**.
