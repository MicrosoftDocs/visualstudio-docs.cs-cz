...
- Podívejte se na clustery s přirozenými závislostmi v kódu. Na panelu nástrojů Mapa klikněte natlačítko rozložení **, rychlé clustery**![rychlé clustery na panelu nástrojů grafu](../modeling/media/quickclustersicon.gif "QuickClustersIcon"). Viz [Změna rozložení mapy](#Selecting).

     ![Rozložení pro &#45; rychlé clustery v grafu závislostí](../modeling/media/dependencygraph-quickclusters.png "DependencyGraph_QuickClusters")
