---
title: Procházení a změna uspořádání kódových map | Dokumenty společnosti Microsoft
ms.date: 11/15/2016
...
- Podívejte se na clustery přirozených závislostí v kódu. Na panelu nástrojů mapy zvolte **Na panelu**nástrojů Graf tlačítko Rozložení , **Rychlé clustery**![Rychlé clustery](../modeling/media/quickclustersicon.gif "Ikona rychlého clusteru"). Viz [Změna rozložení mapy](#Selecting).

     ![Graf závislostí &#45; rozložení Rychlých clusterů](../modeling/media/dependencygraph-quickclusters.png "DependencyGraph_QuickClusters")
...
|------------|-----------------------------|
|Uspořádejte tok závislostí pro celou mapu v určitém směru. To vám může pomoci zobrazit architektonické vrstvy v kódu.|Na panelu nástrojů mapy zvolte **Rozložení**a pak:<br /><br /> -   Tlačítko grafu **shora dolů** ![shora dolů](../modeling/media/topbottomgraphbutton.gif "Horní tlačítko")<br />-   **Tlačítko grafu zdola** ![nahoru nahoru](../modeling/media/bottomtopgraphbutton.gif "Dolní tlačítko TopGraphButton")<br />-   Tlačítko rozložení **Zleva doprava** ![doprava doprava](../modeling/media/leftrightgraphbutton.gif "Levé tlačítko RightGraphButton")<br />-   Tlačítko grafu **zprava doleva** ![Right to Left graph button](../modeling/media/rightleftgraphbutton.gif "Pravé levé tlačítko")|
|Zobrazit clustery přirozených závislostí v kódu s nejvíce závislými uzly ve středu clusterů a nejméně závislými uzly na vnější straně těchto clusterů.|Na panelu nástrojů mapy zvolte **Rozložení**a potom tlačítko **Rychlé clustery**![Rychlé clustery na panelu nástrojů grafu](../modeling/media/quickclustersicon.gif "Ikona rychlého clusteru").|
...
|Změňte velikost a vejde mapu do okna.|Ze seznamu **Lupa** na panelu nástrojů mapy kódu zvolte **Lupa, aby se vešel.**<br /><br /> - nebo -<br /><br /> Klepněte na ikonu **Lupa, aby se ikona** ![Lupa vešla na panel nástrojů mapy](../modeling/media/almcodemapzoomicon.png "Ikona aplikace ALMCodeMapZoomIkona") na panelu nástrojů mapy kódu. Klávesnice: stiskněte **kombinaci kláves CTRL + 0** (nula).|
|Najít uzel na mapě podle jeho názvu. **Tip:**  To funguje pouze pro položky na mapě. Chcete-li najít položky v řešení, ale ne na mapě, najděte je v **Průzkumníku řešení**a přetáhněte je na mapu. (Přetáhněte výběr nebo na panelu nástrojů Průzkumník řešení klikněte **na Zobrazit na mapě kódu).**|1. Zvolte ![ikonu Najít ikonu Najít na panelu nástrojů mapy](../modeling/media/almcodemapfindicon.png "IKONA ALMCodeMapFindIcon") na panelu nástrojů mapy kódu (Klávesnice: stiskněte **kombinaci kláves CTRL + F)** a zobrazte vyhledávací pole v pravém horním rohu mapy. **Find**<br />2. Zadejte název položky a stiskněte **return** nebo klikněte na ikonu lupy. Na mapě se zobrazí vybraná první položka, která odpovídá vašemu hledání.<br />3. Chcete-li přizpůsobit vyhledávání, otevřete rozevírací seznam a zvolte možnost hledání. Možnosti jsou **Najít další**, **Najít předchozí**a Vybrat **vše**. Pak klikněte na odpovídající tlačítko vedle vyhledávacího textového pole.<br />     ![Rozevírací seznam možností hledání&#45;](../modeling/media/almcodemapssearchdropdown.png "ALMCodeMapsVyhledatDropdown")<br />     Případně použijte klávesnici: stisknutím **klávesy F3** vyberte další odpovídající uzel nebo **SHIFT + F3** a vyberte předchozí odpovídající uzel.<br />4. Vyberte některou z možností, které určují, jak jsou vyhledávací termíny zpracovávány, kliknutím na ikony pod vyhledávacím textovým polem.<br />     ![Možnosti shody hledání](../modeling/media/almcodemapssearchmatchicons.png "IKONY ALMCodeMapsSearchMatchIkony")<br />     Možnosti jsou, zleva doprava, malá a velká písmena odpovídající, odpovídají pouze celá slova, použijte .NET regulární výraz syntaxe, automaticky rozbalit skupiny zobrazit shody na uzavřené položky. **Důležité:**  Vyhledávací pole můžete použít k vyhledání shod ve sbalených skupinách pouze v případě, že tyto skupiny byly dříve rozbaleny. Chcete-li tyto shody najít a automaticky rozbalit jejich nadřazené skupiny, zvolte tuto možnost pod vyhledávacím polem.|
...
|**Akce**|**Provedení těchto kroků**|
|------------|-----------------------------|
|Zobrazení nebo skrytí podokna Filtry|Zvolte tlačítko **Filtry** na panelu nástrojů mapy kódu. Podokno Filtry se ve výchozím nastavení zobrazuje jako stránka s kartami v okně Průzkumník řešení.|
...
|Zobrazí skryté uzly.|- Chcete-li zobrazit všechny skryté uzly uvnitř skupiny, nejprve se ujistěte, že je skupina rozbalena. Otevřete místní nabídku a zvolte **Vybrat**, **Zobrazit děti**.<br />     - nebo -<br />     V levém horním rohu skupiny klikněte na ikonu **Zobrazit**![podřízené](../modeling/media/dependencygraph-filtericon-hiddennodes.gif "DependencyGraph_FilterIcon_HiddenNodes") děti (tato ikona je viditelná pouze v případě, že jsou skryté podřízené uzly).<br />- Chcete-li zobrazit všechny skryté uzly, otevřete místní nabídku mapy nebo uzlu a zvolte **Vybrat**, **Zobrazit vše**.|
...
|Přidejte nový uzel stejného typu a propojený z existujícího uzlu.|1. Vyberte prvek kódu. Nad ním se zobrazí rozbalovací panel nástrojů.<br />     ![Panel nástrojů grafu závislostí](../modeling/media/depedencygraph-toolbar.png "DepedencyGraph_Toolbar")<br />2. Na panelu nástrojů zvolte druhou ikonu **Vytvořte uzel se stejnou kategorií jako tento uzel a přidejte k němu nový odkaz**.<br />3. Vyberte místo na mapě, aby nový prvek kódu a klikněte na levé tlačítko myši.<br />4. Zadejte název nového uzlu a stiskněte **return**.|
...
4. Vyberte prvek zdrojového kódu na mapě.

5. Pokud máte nainstalovanou myš, přesuňte ukazatel myši mimo hranice mapy.

6. Otevřete místní nabídku prvku kódu a zvolte **Upravit**, **Přidat**, **Obecný odkaz**.

7. Tabulátorem a vyberte prvek cílového kódu pro propojení.

8. Stiskněte **klávesu RETURN**.
...
5. Upravte vlastnost **Label** v okně Vlastnosti sady Visual Studio.
...
1. Vyberte prvek kódu nebo odkaz a stiskněte klávesu **Delete.**
     ...
     Otevřete místní nabídku prvku kódu nebo odkazu a zvolte **Upravit**, **Odebrat**.

2. Pokud je prvek nebo odkaz součástí skupiny, zobrazí se uvnitř skupiny tlačítko **Znovu načíst podřízené** ![objekty.](../modeling/media/dependencygraph-deletednodesicon.png "DependencyGraph_DeletedNodesIcon") Klepnutím na toto tlačítko načtete chybějící prvky a odkazy.
...
- Změňte barvu pozadí prvku nebo zrušte zaškrtnutí příznaku zpracování výběrem **volby Upravit**, **Jiné barvy příznaku**.
...
## <a name="see-also"></a>Viz také
 [Mapovat závislosti napříč vašimi řešeními](../modeling/map-dependencies-across-your-solutions.md) [Pomocí map kódu můžete ladit aplikace](../modeling/use-code-maps-to-debug-your-applications.md) Hledání potenciálních problémů pomocí [analyzátorů map kódů](../modeling/find-potential-problems-using-code-map-analyzers.md) Přizpůsobení map kódu úpravou odkazu na [směrované grafy (DGML)](../modeling/directed-graph-markup-language-dgml-reference.md) souborů [DGML](../modeling/customize-code-maps-by-editing-the-dgml-files.md)