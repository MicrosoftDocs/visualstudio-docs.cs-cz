...
Při prvním otevření řešení Nástroje DSL (nástroje DSL) v nástroji [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] bude uživatelské rozhraní vypadat podobně jako na následujícím obrázku.
