---
title: Práce s průzkumníkem jazyka specifického pro doménu | Microsoft Docs
ms.date: 11/15/2016
...
- **Tvůrci připojení**. Seznam tvůrců připojení v modelu. Další informace o sestavách připojení najdete v tématu [přizpůsobení vytváření propojení – přesměrování](../misc/customizing-link-creation-redirection.md).

- **Konektory**. Seznam elementů diagramu konektoru v modelu Další informace o konektorech najdete v tématu [typy obrazců a konektorů – přesměrování](../misc/types-of-shapes-and-connectors-redirect.md).
