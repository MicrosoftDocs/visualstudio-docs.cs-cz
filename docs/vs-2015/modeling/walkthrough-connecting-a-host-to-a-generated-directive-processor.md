---
title: 'Návod: připojení hostitele k procesoru vygenerovaných direktiv | Microsoft Docs'
ms.date: 11/15/2016
...
- Použití [!INCLUDE[dsl](../includes/dsl-md.md)] k vygenerování procesoru direktiv, který je založen na doménovém modelu.
...
## <a name="using-domain-specific-language-tools-to-generate-a-directive-processor"></a>Generování procesoru direktiv pomocí Nástroje DSL
...
#### <a name="to-use-domain-specific-language-tools-to-generate-a-directive-processor-that-is-based-on-a-domain-model"></a>Použití Nástroje DSL k vygenerování procesoru direktiv založeného na modelu domény
...
#### <a name="to-connect-a-custom-text-template-host-to-the-generated-directive-processor"></a>Připojení vlastního hostitele textových šablon k procesoru vygenerovaných direktiv
...
4. Zadejte cestu k souboru textové šablony a stiskněte klávesu ENTER.
    ...
    > [!NOTE]
    > Místo zadání adresy můžete v **Průzkumníkovi Windows**vyhledat soubor TestTemplateWithDP. txt a pak ho přetáhnout do okna příkazového řádku.
