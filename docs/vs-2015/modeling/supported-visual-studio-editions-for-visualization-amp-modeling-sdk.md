...
Toto jsou seznamy edice sady Visual Studio, které jsou podporovány [!INCLUDE[dsl](../includes/dsl-md.md)] v prostředí pro vytváření a nasazení. Další informace o těchto vydáních najdete v tématu Microsoft [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] [středisko pro vývojáře](https://go.microsoft.com/fwlink/?LinkId=75628).
