...
|**Nasazení služby WCF:** Jiné aplikace mohou používat služby WCF RIA, které nasadíte na webový server.|[Nasazení řešení služeb WCF RIA](https://msdn.microsoft.com/library/ff426912\(v=vs.91\).aspx)|  
|**Nasazení služby OData:** Jiné aplikace mohou používat služby OData, které nasadíte na webový server.|[Nasazení služby OData](https://msdn.microsoft.com/library/hh973447.aspx)|  
