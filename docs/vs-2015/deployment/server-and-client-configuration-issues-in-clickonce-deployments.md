...
## <a name="http-compression-issues"></a>Problémy s kompresí HTTP  
 ...
 Podrobné pokyny pro službu IIS najdete v tématu [Určení dalších typů dokumentů pro kompresi HTTP](https://go.microsoft.com/fwlink/?LinkId=178459).  
