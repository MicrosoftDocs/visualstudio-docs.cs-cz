---
title: 'Základy ladění: okno Registry | Microsoft Docs'
ms.date: 11/15/2016
...
Okno **Registry** je k dispozici pouze v případě, že je povoleno ladění na úrovni adresy v dialogovém okně **Možnosti** , uzel **ladění** .  
 ...
 Když se podíváte na okno **Registry** , zobrazí se položky, jako je například tento příklad:  
  
```  
EAX = 003110D8  
```  
  
 Symbol nalevo od znaménka = je název registru EAX vrátí, v tomto případě. Číslo napravo od znaménka = představuje obsah registru.  
