...
- U volání vnořené funkce **Krokovat s vnořením** přejde k nejhlouběji vnořené funkci. Použijete-li **Krok do** pro volání, jako je `Func1(Func2())`, ladicí program kroky do funkce `Func2`.  
