...
Poslední dokumentaci k sadě Visual Studio 2017 najdete v tématu [Průvodce pro C++ přenos a upgrade vizuálů](https://docs.microsoft.com/cpp/porting/visual-cpp-porting-and-upgrading-guide).
