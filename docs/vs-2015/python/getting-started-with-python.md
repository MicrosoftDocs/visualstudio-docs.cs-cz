...
Pro instalaci samotného Pythonu navštivte [https://www.python.org/download/](https://www.python.org/download/) .
...
- Chcete-li nainstalovat sadu SDK, použijte [index balíčku Python](https://pypi.python.org/pypi/azure) nebo proveďte [instalaci PYTHONU a sadu SDK](/azure/developer/python/azure-sdk-install) v dokumentaci k Azure. 
...
[Začínáme s PTVS: nastavení sady Visual Studio](../python/getting-started-with-ptvs-setting-up-visual-studio.md) 
 [Začínáme s PTVS: spustit kódování (projekty)](../python/getting-started-with-ptvs-start-coding-projects.md) 
 ...
 [Začínáme s PTVS: Interactive Python](../python/getting-started-with-ptvs-interactive-python.md) 
