...
|-------------------|--------------|-----------|
|<xref:System.Activities.Statements.If.Condition%2A>|Podmínka|Podmínka, která určuje, která podřízená aktivita má být provedena. Chcete-li nastavit <xref:System.Activities.Statements.If.Condition%2A>, zadejte výraz [!INCLUDE[vbprvb](../includes/vbprvb-md.md)] do pole **Podmínka** v Návrháři aktivity **if** nebo v mřížce vlastností.|
