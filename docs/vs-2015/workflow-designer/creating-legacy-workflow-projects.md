---
title: Vytváření projektů pracovních postupů starší verze | Microsoft Docs
ms.date: 11/15/2016
...
|Knihovna aktivit pracovního postupu|Projekt pro vytvoření knihovny aktivit, kterou lze později znovu použít jako stavební bloky v pracovních postupech.|
|Konzolová aplikace pracovního postupu stavového stroje|Projekt pro vytvoření konzolové aplikace pracovního postupu stavového stroje|
|Knihovna pracovního postupu stavového stroje|Projekt pro vytvoření knihovny pracovního postupu stavového stroje|
...
## <a name="see-also"></a>Viz také
 [Zobrazení sekvenčních pracovních postupů (starší verze)](../workflow-designer/sequential-workflow-views-legacy.md) [Windows pracovního postupu sady Visual Studio (starší verze)](../workflow-designer/visual-studio-workflow-windows-legacy.md)