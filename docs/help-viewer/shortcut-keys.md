...
|Panel nástrojů|**ALT** + **Domovská stránka**|Zobrazit domovskou stránku **kontrolora pomocníka** .|
...
|Panel nástrojů|**CTRL** + **Posun** + **M**|Zobrazte kartu **Spravovat obsah** .|
|Navigátory|**ALT** + Jazyk **C**<br /><br /> - nebo -<br /><br /> **CTRL** + **Posun** + Jazyk **C**|Zobrazte kartu **obsah** .|
|Navigátory|**ALT** + **I**<br /><br /> - nebo -<br /><br /> **CTRL** + **Posun** + **I**|Zobrazte kartu **index** .|
|Navigátory|**ALT** + **F**<br /><br /> - nebo -<br /><br /> **CTRL** + **Posun** + **F**|Zobrazte kartu **Oblíbené** .|
|Navigátory|**ALT** + **S**<br /><br /> - nebo -<br /><br /> **CTRL** + E<br /><br /> - nebo -<br /><br /> **CTRL** + **Posun** + **S**|Zobrazte kartu **Vyhledat** .|
|Navigátory|**ALT** + **M**<br /><br /> - nebo -<br /><br /> **CTRL** + **Posun** + **M**|Zobrazte kartu **Spravovat obsah** .|
|Téma|Klávesa **místní nabídky**<br /><br /> NEBO<br /><br /> **Posun** + **F10**|Zobrazení místní nabídky pro aktuální prvek uživatelského rozhraní.|
