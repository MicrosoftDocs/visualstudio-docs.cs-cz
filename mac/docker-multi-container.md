...
1. V okně řešení klikněte pravým tlačítkem na projekt DockerDemoFrontEnd a vyberte **přidat > přidat podporu Docker** : ![ Přidat podporu Docker.](media/docker-quickstart-3.png)
...
1. Po vytvoření přejděte do okna řešení, klikněte pravým tlačítkem na projekt MyWebAPI a vyberte **přidat > přidat podporu Docker**.
