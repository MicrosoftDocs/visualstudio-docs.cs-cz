...
Než se přihlásíte k Visual Studio pro Mac, ujistěte se, že jste připojení k Internetu. Odběry lze aktivovat pouze online.

Pokud se chcete přihlásit k Visual Studio pro Mac, proveďte následující kroky:

1. Kliknutím na odkaz **Přihlásit** na úvodní stránce zobrazíte dialogové okno účty a stisknete tlačítko **Přihlásit** se:
...
2. Zadejte svoje přihlašovací údaje Microsoftu:
    ...
    K přihlášení do Visual Studio pro Mac se nedají použít přihlašovací údaje Xamarin.

3. Po přihlášení se zobrazí váš typ licence. V tomto dialogovém okně můžete přidat další účty Microsoft, které byste mohli chtít použít:
...
Pokud chcete přidat další uživatelské účty, postupujte podle kroků v části [jak se přihlašovat k Visual Studio pro Mac](#how-to-sign-in-to-visual-studio-for-mac) .
