...
Nástroje funkce Azure jsou součástí **Visual Studia pro Mac 7.5**.

K vytváření a nasazování funkcí potřebujete také předplatné [https://azure.com/free](https://azure.com/free)Azure, které je k dispozici zdarma.
...
4. V dialogovém okně **Vytvořit novou službu App Service** zadejte nastavení: ![Publikovat do nabídky Azure.](media/azure-functions-image7.png)
    ...
    > [!CAUTION]
    > V verzi 7.6 sady Visual Studio for Mac je chyba, která způsobí selhání publikování s chybou zřizování, pokud se pokusíte vytvořit vlastní plán služeb s **cenou nastavenou** na **spotřebu**. Tato oprava bude opravena v další verzi služby.
...
> [!CAUTION]
> Ve verzi 7.6 sady Visual Studio for Mac `FUNCTIONS_EXTENSION_VERSION` je chyba, kde není správně nastavena na "beta", což znamená, že vaše funkce nemusí být spuštěna. Chcete-li tento problém vyřešit, `FUNCTIONS_EXTENSION_VERSION` přejděte do nastavení aplikace [Function](#function-app-settings) a nastavte z "-1" na "beta".
...
Pokud chcete získat přístup k nastavení [https://ms.portal.azure.com/](https://ms.portal.azure.com/)aplikace, přejděte na webu Azure Portal na adrese . V části **Functions Apps**vyberte **Function Apps** a zvýrazněte název funkce:
