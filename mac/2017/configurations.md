...
Jiné aktivity než `MainLauncher` budou muset `Exported=true` přidat do atributu Activity pro ladění na fyzickém zařízení nebo mít definované filtry záměrů.
