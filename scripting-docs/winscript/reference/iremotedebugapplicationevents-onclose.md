---
title: 'Iremotedebugapplicationevents –:: Close | Microsoft Docs'
ms.custom: ''
ms.date: 01/18/2017
ms.reviewer: ''
ms.suite: ''
...
## <a name="remarks"></a>Poznámky  
 Tato metoda zpracovává událost zavření aplikace.  
