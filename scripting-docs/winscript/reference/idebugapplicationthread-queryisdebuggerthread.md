...
|Hodnota|Popis|  
|-----------|-----------------|  
|`S_OK`|Metoda byla úspěšná a jedná se o vlákno ladicího programu.|  
|`S_FALSE`|Toto není vlákno ladicího programu.|  
  
## <a name="remarks"></a>Poznámky  
 Tato metoda určuje, zda je toto vlákno podprocesem ladicího programu.  
