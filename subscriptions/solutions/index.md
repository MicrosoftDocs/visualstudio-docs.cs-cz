---
title: Řešení podpory předplatných
description: Seznam zahrnutých souborů pro podporu pro odběry sady Visual Studio – obsah widgetu
ms.topic: conceptual
...
ms.locfileid: "100496279"
---
# <a name="visual-studio-subscriptions-support-widget-content-includes-files"></a>Obsah widgetu pro podporu předplatných sady Visual Studio zahrnuje soubory

## <a name="admin-solutions"></a>Řešení pro správu
...
## <a name="benefit-activations"></a>Aktivace výhod
...
## <a name="download-activate-or-use-software"></a>Stažení, aktivace nebo použití softwaru

### <a name="downloads-and-activations"></a>Stahování a aktivace
...
### <a name="find-and-use-product-keys"></a>Vyhledání a použití kódů Product Key
...
### <a name="use-product-features"></a>Použití funkcí produktu
...
## <a name="other-solutions-or-no-solution"></a>Další řešení nebo žádné řešení

[!INCLUDE [No solution](other-or-no-solution/includes/no-solution.md)]

## <a name="portal-issues"></a>Potíže s portálem
...
## <a name="purchase-renew-or-cancel-subscriptions"></a>Nákup, obnovení nebo zrušení předplatných

### <a name="help-with-purchases"></a>Pomáhat s nákupy
...
### <a name="help-with-renewals"></a>Pomáhat s obnovením
...
### <a name="help-with-canceling"></a>Pomáhat s zrušením
...
### <a name="order-or-purchase-status"></a>Stav objednávky nebo nákupu
...
## <a name="issues-with-signing-in"></a>Problémy s přihlašováním 
