...
Nejste si jistí, jaké Předplatné používáte?  Pokud si chcete zobrazit všechna předplatná, která máte přiřazená, připojte se k [https://my.visualstudio.com/subscriptions](https://my.visualstudio.com/subscriptions?wt.mc_id=o~msft~docs) .
