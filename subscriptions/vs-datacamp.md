...
|--------------------------------------------------------------------|---------------------------------------------------------|------------------------------------------------------------------|---------------|
| Visual Studio Enterprise (Standard)   | VL, Azure, Retail, | 3-months       |  Ne.  Available to new subscribers only          |
| Visual Studio Enterprise with GitHub Enterprise   | VL | 3-months       |  Ne.  Available to new subscribers only          |
| Visual Studio Professional (Standard) | VL, Azure, Retail                                       | 3-months                                                            |  Ne.  Available to new subscribers only           |
| Visual Studio Professional with GitHub Enterprise| VL | 3-months                                                            |  Ne.  Available to new subscribers only           |
| Visual Studio Test Professional (Standard)                         | VL, Retail                                              | 3-months                                             |  Ne.  Available to new subscribers only           |
| MSDN Platforms (Standard)                                          | VL, Retail                                              | 3-months                                              |  Ne.  Available to new subscribers only           |
| Visual Studio Enterprise (Standard)  | NFR<sup>1</sup> |Not available  | Není k dispozici |
| Visual Studio Enterprise, Visual Studio Professional (monthly cloud) | Azure | Not available | Není k dispozici |
