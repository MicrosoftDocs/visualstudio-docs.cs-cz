...
1. Pokud chcete aktivovat své předplatné, připojte se [https://my.visualstudio.com/benefits](https://my.visualstudio.com/benefits?wt.mc_id=o~msft~docs) a klikněte na odkaz **získat kód** na dlaždici výhody Pluralsight, která se nachází v části profesionální vývoj.
   > [!div class="mx-imgBorder"]
   > Dlaždice výhody ![Pluralsight](_img/vs-pluralsight/vs-pluralsight-3month-tile.png)
   >
   > [!IMPORTANT]
...
3. Budete přesměrováni na stránku Pluralsight, kde najdete výhody, které jsou součástí vašeho předplatného sady Visual Studio.
   ...
   > [!div class="mx-imgBorder"]
   > ![Pluralsight aktivujte své výhody](_img/vs-pluralsight/vs-pluralsight-create-account.png)
...
<sup>1</sup>  *zahrnuje: Not for Reprodej (NFR), Visual Studio Industry Partner (VSIP), BizSpark, MCT software & Services Developer, MCT software &AMP; Service, MVP (MVP Professional), oblastní ředitel (RD), Microsoft Partner Network (MPN), FTE, představte.*
