...
| Visual Studio Professional (Standard<sup>2</sup>) | VL, Azure, Retail                                       | K dispozici                                                            |  Ne          |
...
<sup></sup>1*zahrnuje:    Ne pro prodej (NFR), Visual Studio Industry Partner (VSIP), FTE, BizSpark, Představte si prémii.  Vyloučí Microsoft Partner Network (MPN), nejkomplexnější specialista (MVP), oblastní ředitel (RD), MCT software & Services, vývojář, MCT software & Services, Představte si.*
...
### <a name="q-if-the-subscription-is-free-why-am-i-being-asked-for-a-credit-card"></a>Č Pokud je předplatné bezplatné, proč se mi požaduje platební karta?  
O: Posílání bezplatných tiskových kopií po jednotlivých cenách je nenáročné.  Předplatitelé vybírající tiskovou edici časopisu CODE Magazine a nacházejí mimo USA se účtují za expedici. Chcete-li se vyhnout poplatkům za expedici, vyberte digitální verzi časopisu. 

### <a name="q-why-do-i-need-to-provide-a-delivery-address-for-a-digital-subscription"></a>Č Proč potřebuji zadat doručovací adresu pro digitální předplatné?
O:  Časopis CODE shromažďuje vaši adresu bez ohledu na to, jestli je předplatné pro tisk nebo digitální předplatné, které podporuje plnění, výběr nabídky a procesy digitálního přístupu.  Další informace o tom, co časopis CODE Magazine s Vašimi daty, najdete v [zásadách ochrany osobních údajů](https://www.codemag.com/Home/Privacy).
...
Podívejte se na zbytek skvělé výhody, které jsou součástí vašeho předplatného. Přejděte [https://my.visualstudio.com/benefits](https://my.visualstudio.com/benefits?wt.mc_id=o~msft~docs)na adresu.
