...
4. Budete přesměrováni na úvodní stránku časopisu CODE Magazine. Vyberte svou zemi/oblast a zvolte, jak se má časopis dostávat. 
   > [!NOTE]
...
|--------------------------------------------------------------------|---------------------------------------------------------|------------------------------------------------------------------|---------------|
| Visual Studio Enterprise (Standard)   | VL, Azure, Retail| K dispozici       |  No          |
| Visual Studio Enterprise předplatné s GitHubem Enterprise   | VL| K dispozici       |  No          |
| Visual Studio Professional (Standard) | VL, Azure, Retail                                       | K dispozici                                                            |  No          |
| Visual Studio Professional předplatné s GitHubem Enterprise | VL                                      | K dispozici                                                            |  No          |
...
| Visual Studio Enterprise NFR<sup>1</sup> | NFR | Není k dispozici | – |

<sup>1</sup>  * zahrnuje: ne pro opětovné vyprodej (NFR), Visual Studio Industry Partner (VSIP), ekvivalent, BizSpark, Představte si Premium, Microsoft Partner Network (MPN), nejčastější profesionální specialisty (MVP), oblastní ředitel (RD), MCT software & Services Developer, MCT software & Services.  
