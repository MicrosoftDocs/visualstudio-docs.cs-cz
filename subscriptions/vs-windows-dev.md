...
Pro tento proces doporučujeme vytvořit okno prohlížeče "soukromé".  Například v Google Chrome vytvořte nové okno "incongnito".  V Internet Exploreru vytvořte nové okno InPrivate.
...
Azure je osobní izolovaný prostor pro vývoj a testování.  Můžete zřídit virtuální počítače, cloudové služby a další prostředky Azure. Nezapomeňte aktivovat [zvýhodnění Azure](vs-azure.md) , abyste mohli začít používat váš jednotlivý kredit Azure DevTest.